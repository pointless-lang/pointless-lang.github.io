...
(function dartProgram() {
  ...
  P = {
    ...
    _exceptionFromResponse: function(response, message, path) {
      ...
      switch (t1.$index(response, 0)) {
        ...
        case 2:
          return new P.FileSystemException(message, path, new P.OSError(H._asStringS(t1.$index(response, 2)), H._asIntS(t1.$index(response, 1))));
        case 3:
    ...
    File_File: function(path) {
      ...
      t1 = P.FileSystemEntity__toNullTerminatedUtf8Array(C.C_Utf8Encoder.convert$1(path));
      return new P._File(path, t1);
    },
  ...
  G = {
    IHashMap_IHashMap$empty: function($K, $V) {
      var t1 = type$.$env_1_1_legacy_int._bind$1($K._eval$1("@<0>")._bind$1($V)._eval$1("IList<Tuple2<1*,2*>*>*"));
      return new G.IHashMap(new G.IMap($.$get$IntOrder(), new G._EmptyIMapAVLNode(t1._eval$1("_EmptyIMapAVLNode<1,2>")), t1._eval$1("IMap<1,2>")), $K._eval$1("@<0*>")._bind$1($V._eval$1("0*"))._eval$1("IHashMap<1,2>"));
    },
    IHashMap_IHashMap$from: function(m, $K, $V) {
      return new H.LinkedHashMapKeyIterable(m, H._instanceType(m)._eval$1("LinkedHashMapKeyIterable<1>")).fold$1$2(0, G.IHashMap_IHashMap$empty($K._eval$1("0*"), $V._eval$1("0*")), new G.IHashMap_IHashMap$from_closure(m, $K, $V), $K._eval$1("@<0>")._bind$1($V)._eval$1("IHashMap<1*,2*>*"));
    },
    ...
    IVector_IVector$from: function(iterable, $A) {
      var t1 = type$.$env_1_1_legacy_int._bind$1($A._eval$1("0*"));
      return C.JSArray_methods.fold$1$2(iterable, new G.IVector(new G.IMap($.$get$IntOrder(), new G._EmptyIMapAVLNode(t1._eval$1("_EmptyIMapAVLNode<1,2>")), t1._eval$1("IMap<1,2>")), 0, 0, $A._eval$1("IVector<0*>")), new G.IVector_IVector$from_closure($A), $A._eval$1("IVector<0*>*"));
    },
    none: function($A) {
  ...
  X = {
    ...
    PtlsList_fromValues: function(values) {
      var t2, cur, thunk, thunk0,
        result = new R.PtlsLabel("Empty"),
        t1 = H.setRuntimeTypeInfo([], type$.JSArray_legacy_PtlsValue);
      for (t2 = J.get$iterator$ax(values); t2.moveNext$0();)
        C.JSArray_methods.add$1(t1, t2.get$current(t2));
      t2 = type$.ReversedListIterable_legacy_PtlsValue;
  ...
  F = {UrlStyle: function UrlStyle(t0, t1, t2, t3) {
    ...
    handleUnaryOp: function(env, op, operandNode) {
      ...
      switch (op) {
        case C.Tok_40:
          t1 = H.setRuntimeTypeInfo([C.Type_PtlsNumber_2Vr], type$.JSArray_legacy_Type);
          t1 = type$.legacy_PtlsNumber._as(A.$eval(env, operandNode).checkType$1(t1)).value;
          if (typeof t1 !== "number")
            return t1.$negate();
          return new S.PtlsNumber(-t1);
        case C.Tok_42:
          t1 = H.setRuntimeTypeInfo([C.Type_PtlsBool_eoR], type$.JSArray_legacy_Type);
          return new F.PtlsBool(!H.boolConversionCheck(type$.legacy_PtlsBool._as(A.$eval(env, operandNode).checkType$1(t1)).value));
        default:
    ...
    handleBinaryOp: function(env, op, lhsNode, rhsNode) {
      ...
      switch (op) {
        case C.Tok_12:
          ...
          return type$.legacy_PtlsList._as(lhs).concat$2(env, rhsNode);
        case C.Tok_45:
          t1 = type$.JSArray_legacy_Type;
          t2 = H.setRuntimeTypeInfo([C.Type_PtlsBool_eoR], t1);
          if (H.boolConversionCheck(type$.legacy_PtlsBool._as(A.$eval(env, lhsNode).checkType$1(t2)).value))
        ...
        case C.Tok_27:
          ...
          t1 = H.setRuntimeTypeInfo([C.Type_PtlsSet_V0W, C.Type_PtlsDict_UYK], type$.JSArray_legacy_Type);
        ...
        case C.Tok_14:
          ...
          if (t1 === 0) {
            error = new S.PtlsError("Arithmetic Error", P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
  ...
  L = {WindowsStyle: function WindowsStyle(t0, t1, t2, t3) {
      ...
      _.rootPattern = t2;
      _.relativeRootPattern = t3;
    }, PtlsException: function PtlsException(t0, t1) {
      this.value = t0;
      this.loc = t1;
    },
    PtlsValue_update: function(env, accessor, result) {
      ...
      if (t1 === C.Node_12) {
        ...
        if (1 >= t4)
          return H.ioore(t2, 1);
        result = lhs.updateField$2(H._asStringS(J.$index$asx(t2[1], 0)), result);
      }
      if (0 >= t2.length)
        return H.ioore(t2, 0);
  ...
  D = {
    checkArity: function(label, args, arity) {
      ...
      if (args.length !== arity) {
        error = new S.PtlsError("Output Error", P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
    ...
    invalidLabel: function(label) {
      var error = new S.PtlsError("Output Error", P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
  ...
  Q = {
    Env$: function($parent) {
      var t1 = new Q.Env($parent, P.LinkedHashMap_LinkedHashMap$_empty(type$.legacy_String, type$.legacy_Thunk)),
        t2 = $parent == null,
  ...
  A = {
    $eval: function(env, node) {
      ...
      if ($.depth > 1000) {
        error = new S.PtlsError("Recursion Error", P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
        error.message = "Max call depth (1000) exceeded";
        throw H.wrapException(error);
      }
      result = null;
      traceLocs = P.LinkedHashSet_LinkedHashSet(type$.legacy_Location);
      try {
        $.depth = $.depth + 1;
    ...
    dispatch: function(env, node, traceLocs) {
      var exc, valNode, callCond, cond, funcNode, callHandler, t1, t2, t3, t4, t5, elemNode, t6, t7, t8, func, arg, newEnv, thunk, error, pair, lhs, imptPath, source, result, cur, $export, imports, defs, $name, nameNode, exception, memNode, index, index0, _null = null, _box_0 = {};
      _box_0.env = env;
      node = node;
      for (t1 = type$.legacy_ASTNode, t2 = type$.JSArray_legacy_Type, t3 = type$.legacy_PtlsBool, t4 = type$.legacy_PtlsObject, t5 = type$.JSArray_legacy_ASTNode; true;) {
        $.lastLoc = node.loc;
        switch (node.nodeType) {
          case C.Node_0:
            t2 = H.setRuntimeTypeInfo([], type$.JSArray_legacy_PtlsValue);
            t3 = node.values;
            if (0 >= t3.length)
              return H.ioore(t3, 0);
            t3 = J.get$iterator$ax(type$.legacy_Iterable_dynamic._as(t3[0]));
            for (; t3.moveNext$0();) {
              elemNode = t3.get$current(t3);
              C.JSArray_methods.add$1(t2, A.$eval(_box_0.env, t1._as(elemNode)));
            }
            return new T.PtlsArray(G.IVector_IVector$from(t2, type$.legacy_PtlsValue));
          case C.Node_1:
            t2 = _box_0.env;
            t3 = node.values;
            if (0 >= t3.length)
              return H.ioore(t3, 0);
            t3 = type$.legacy_Tok._as(t3[0]);
            t4 = node.values;
            if (1 >= t4.length)
              return H.ioore(t4, 1);
            t4 = t1._as(t4[1]);
          ...
          case C.Node_3:
            ...
            if (0 >= t1.length)
              return H.ioore(t1, 0);
            return new F.PtlsBool(H._asBoolS(t1[0]));
          case C.Node_4:
            t6 = _box_0.env;
            t7 = node.values;
            if (0 >= t7.length)
              return H.ioore(t7, 0);
            t7 = t1._as(t7[0]);
            t8 = H.setRuntimeTypeInfo([C.Type_PtlsBuiltIn_jyx, C.Type_PtlsFunc_ODT], t2);
            func = A.$eval(t6, t7).checkType$1(t8);
            t8 = _box_0.env;
            t7 = node.values;
            if (1 >= t7.length)
              return H.ioore(t7, 1);
            arg = A.$eval(t8, t1._as(t7[1]));
            if (func instanceof X.PtlsFunc) {
              newEnv = func.env.clone$0(0);
              t6 = func.params;
              t7 = newEnv.defs._length;
              if (t7 < 0 || t7 >= t6.length)
                return H.ioore(t6, t7);
              thunk = new A.Thunk(t6[t7], _null);
              thunk.value = arg;
              newEnv.addDefThunk$1(thunk);
              if (newEnv.defs._length < t6.length)
                return new X.PtlsFunc(newEnv, t6, func.body);
            ...
            if (func instanceof G.PtlsBuiltIn)
              return type$.legacy_PtlsValue._as(func.handler.call$1(arg));
            throw H.wrapException(false);
          case C.Node_5:
            t6 = _box_0.env;
            t7 = node.values;
            ...
            if (H.boolConversionCheck(t3._as(A.$eval(t6, t7).checkType$1(t8)).value)) {
              t6 = node.values;
              if (1 >= t6.length)
                return H.ioore(t6, 1);
              node = t1._as(t6[1]);
            ...
            if (2 >= t6.length)
              return H.ioore(t6, 2);
            if (t6[2] == null) {
              error = new S.PtlsError("Condition Error", P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
            ...
            continue;
          case C.Node_7:
            t2 = type$.legacy_PtlsValue;
            t3 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t2);
            t4 = node.values;
            if (0 >= t4.length)
              return H.ioore(t4, 0);
            t4 = J.get$iterator$ax(type$.legacy_Iterable_dynamic._as(t4[0]));
            for (; t4.moveNext$0();) {
          ...
          case C.Node_9:
            ...
            if (0 >= t3.length)
              return H.ioore(t3, 0);
            return lhs.getField$2(H._asStringS(t3[0]), node.loc);
          case C.Node_10:
            ...
            t3 = J.get$iterator$ax(type$.legacy_Iterable_dynamic._as(t3[0]));
            for (; t3.moveNext$0();)
              C.JSArray_methods.add$1(t2, H._asStringS(J.$index$asx(t3.get$current(t3), 0)));
            t3 = _box_0.env;
            t3.toString;
            t3 = Q.Env$(t3);
            t4 = node.values;
          ...
          case C.Node_11:
            ...
            if (0 >= t2.length)
              return H.ioore(t2, 0);
            imptPath = H._asStringS(J.$index$asx(t2[0], 0));
            t1 = t1.loc.path;
          ...
          case C.Node_13:
            ...
            if (0 >= t1.length)
              return H.ioore(t1, 0);
            return new R.PtlsLabel(H._asStringS(t1[0]));
          case C.Node_14:
            result = new R.PtlsLabel("Empty");
            t1 = node.values;
            if (0 >= t1.length)
              return H.ioore(t1, 0);
            t1 = type$.legacy_Iterable_dynamic._as(J.get$reversed$ax(t1[0]));
            t1 = new H.ListIterator(t1, t1.get$length(t1), H._instanceType(t1)._eval$1("ListIterator<ListIterable.E>"));
            for (; t1.moveNext$0();) {
              cur = t1.__internal$_current;
              result = new X.PtlsList(new A.Thunk("", new A.dispatch_closure(_box_0, cur)), new A.Thunk("", new A.dispatch_closure0(result)));
            }
            return result;
          case C.Node_15:
            t1 = _box_0.env;
            ...
            if (0 >= t2.length)
              return H.ioore(t2, 0);
            return t1.lookupName$1(H._asStringS(t2[0]));
          case C.Node_16:
            t1 = node.values;
            if (0 >= t1.length)
              return H.ioore(t1, 0);
            return new S.PtlsNumber(H._asNumS(t1[0]));
          case C.Node_17:
            t2 = _box_0.env;
            t2.toString;
            newEnv = Q.Env$(t2);
            ...
            if (0 >= t2.length)
              return H.ioore(t2, 0);
            t2 = J.get$iterator$ax(type$.legacy_Iterable_dynamic._as(t2[0]));
            for (; t2.moveNext$0();)
          ...
          case C.Node_19:
            ...
            if (1 >= t2.length)
              return H.ioore(t2, 1);
            t3 = type$.legacy_List_legacy_ASTNode;
            imports = t3._as(t2[1]);
            t2 = node.values;
            if (2 >= t2.length)
              return H.ioore(t2, 2);
            ...
            if ($export != null) {
              ...
              for (; t2.moveNext$0();) {
                ...
                if (0 >= t3.length)
                  return H.ioore(t3, 0);
                newEnv.addDefThunk$1(new A.Thunk(H._asStringS(t3[0]), new A.dispatch_closure2(_box_0, nameNode)));
              }
              t1 = new F.PtlsObject(_null, newEnv);
              t1.label = $.$get$PtlsObject_defaultLabel();
              return t1;
          ...
          case C.Node_20:
            ...
            t8 = H.setRuntimeTypeInfo([C.Type_PtlsBool_eoR], t2);
            if (!H.boolConversionCheck(t3._as(A.$eval(t6, t7).checkType$1(t8)).value)) {
              error = new S.PtlsError("Runtime Error", P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
          ...
          case C.Node_23:
            ...
            if (0 >= t1.length)
              return H.ioore(t1, 0);
            return new X.PtlsString(H._asStringS(t1[0]));
          case C.Node_24:
            t2 = _box_0.env;
            t3 = node.values;
            if (0 >= t3.length)
              return H.ioore(t3, 0);
            throw H.wrapException(new L.PtlsException(A.$eval(t2, t1._as(t3[0])), node.loc));
          case C.Node_25:
            try {
              t6 = _box_0.env;
              t7 = node.values;
              if (0 >= t7.length)
                return H.ioore(t7, 0);
              t7 = A.$eval(t6, t1._as(t7[0]));
              return t7;
            } catch (exception) {
              t6 = H.unwrapException(exception);
              if (t6 instanceof L.PtlsException) {
                exc = t6;
                ...
                if (1 >= t7.length)
                  return H.ioore(t7, 1);
                callCond = new U.ASTNode(C.Node_4, t6, [t7[1], H.setRuntimeTypeInfo([valNode], t5)]);
                t7 = _box_0.env;
                t6 = H.setRuntimeTypeInfo([C.Type_PtlsBool_eoR], t2);
                cond = t3._as(A.$eval(t7, callCond).checkType$1(t6));
          ...
          case C.Node_29:
            ...
            if (1 >= t7.length)
              return H.ioore(t7, 1);
            _box_0.env = t4._as(A.$eval(t6, t1._as(t7[1]))).env;
            t7 = node.values;
            if (0 >= t7.length)
              return H.ioore(t7, 0);
            node = t1._as(t7[0]);
          ...
          case C.Node_30:
            ...
            thunk.value = lhs;
            newEnv.addDefThunk$1(thunk);
            t5 = H.setRuntimeTypeInfo([], type$.JSArray_legacy_PtlsValue);
            t2 = node.values;
            if (1 >= t2.length)
              return H.ioore(t2, 1);
            t3 = type$.legacy_Iterable_dynamic;
            t2 = J.get$iterator$ax(t3._as(t2[1]));
            for (; t2.moveNext$0();) {
              t4 = t1._as(t2.get$current(t2)).values;
              if (1 >= t4.length)
                return H.ioore(t4, 1);
              C.JSArray_methods.add$1(t5, A.$eval(newEnv, t1._as(t4[1])));
            }
            t2 = node.values;
            if (1 >= t2.length)
              return H.ioore(t2, 1);
          ...
          case C.Node_21:
            ...
            if (0 >= t1.length)
              return H.ioore(t1, 0);
            return type$.legacy_PtlsValue._as(t1[0]);
          case C.Node_18:
            throw H.wrapException(false);
          case C.Node_2:
            throw H.wrapException(false);
    ...
    SourceFile_getChars: function(path) {
      ...
      try {
        ...
        if (H.unwrapException(exception) instanceof P.FileSystemException) {
          error = new S.PtlsError("File Error", P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
  ...
  P.ListQueue.prototype = {
    ...
    addAll$1: function(_, elements) {
      var addCount, $length, t2, t3, t4, newTable, endSpace, preSpace, _i, t5, split, _this = this,
        t1 = _this.$ti;
      ...
      if (t1._eval$1("List<1>")._is(elements)) {
        ...
        for (t2 = elements.length, t3 = t1._precomputed1, t1 = t1._eval$1("1?"), _i = 0; _i < elements.length; elements.length === t2 || (0, H.throwConcurrentModificationError)(elements), ++_i) {
          ...
          if (_this._collection$_head === t4) {
            newTable = P.List_List$filled(t5 * 2, null, false, t1);
            t4 = _this._table;
  ...
  P._File.prototype = {
    ...
    readAsBytesSync$0: function() {
      P._File__open(P._Namespace__namespace(), this._rawPath, 0);
      var opened = null;
    },
    _tryDecode$2: function(bytes, encoding) {
      ...
      try {
        ...
        H.unwrapException(exception);
        t1 = P.FileSystemException$("Failed to decode data using encoding 'utf-8'", this._io$_path, null);
        throw H.wrapException(t1);
      }
    },
    toString$0: function(_) {
      return "File: '" + H.S(this._io$_path) + "'";
    }
  };
  P._File_length_closure.prototype = {
    call$1: function(response) {
      if (P._isErrorResponse(response))
        throw H.wrapException(P._exceptionFromResponse(response, "Cannot retrieve length of file", this.$this._io$_path));
  ...
  G.IHashMap.prototype = {
    $get$1: function(_, k) {
      ...
      t1._eval$1("1*")._as(k);
      t2 = this._dartz$_map;
      t2 = t2._tree.$get$2(0, t2._order, t2.$ti._eval$1("1*")._as(J.get$hashCode$(k)));
      t3 = t1._eval$1("2*");
      return t2.fold$1$2(0, H.instantiate1(G.dartz__none$closure(), t3), H._instanceType(t2)._bind$1(t3)._eval$1("Option<1*>*(Option.A*)*")._as(new G.IHashMap_get_closure(this, k)), t1._eval$1("Option<2*>*"));
    },
    $index: function(_, k) {
      return this.$get$1(0, this.$ti._eval$1("1*")._as(k));
    },
    ...
    remove$1: function(_, k) {
      var t1 = this.$ti;
      t1._eval$1("1*")._as(k);
      return new G.IHashMap(this._dartz$_map.modify$3(0, J.get$hashCode$(k), new G.IHashMap_remove_closure(this, k), new G.Nil(t1._eval$1("Nil<Tuple2<1*,2*>*>"))), t1._eval$1("@<1*>")._bind$1(t1._eval$1("2*"))._eval$1("IHashMap<1,2>"));
    },
    toMap$0: function() {
      var t1 = this.$ti;
      return this.foldLeftKV$1$2(new H.JsLinkedHashMap(t1._eval$1("@<1*>")._bind$1(t1._eval$1("2*"))._eval$1("JsLinkedHashMap<1,2>")), new G.IHashMap_toMap_closure(this), t1._eval$1("Map<1*,2*>*"));
    },
    foldLeftKV$1$2: function(z, f, $B) {
      var t1 = $B._eval$1("0*");
      return this._dartz$_map.foldLeft$1$2(t1._as(z), new G.IHashMap_foldLeftKV_closure(this, this.$ti._bind$1($B)._eval$1("1*(1*,2*,3*)*")._as(f), $B), t1);
    },
    foldLeft$1$2: function(z, f, $B) {
      var t1 = $B._eval$1("0*");
      return this._dartz$_map.foldLeft$1$2(t1._as(z), new G.IHashMap_foldLeft_closure(this, this.$ti._bind$1($B)._eval$1("1*(1*,3*)*")._as(f), $B), t1);
    },
    toString$0: function(_) {
      return "ihashmap{" + H.S(this._dartz$_map.foldMap$1$2($.$get$IListMi(), new G.IHashMap_toString_closure(this), type$.legacy_IList_dynamic).intercalate$2($.$get$StringMi(), ", ")) + "}";
    },
    $eq: function(_, other) {
      var t1;
      if (other == null)
    ...
    length$0: function(_) {
      return this.foldLeft$1$2(0, new G.IHashMap_length_closure(this), type$.legacy_int);
    },
    pairIterable$0: function() {
      var t3,
        t1 = this._dartz$_map,
        t2 = t1.$ti;
      t2 = t2._eval$1("@<1*>")._bind$1(t2._eval$1("2*"))._eval$1("_IMapValueIterable<1,2>");
  ...
  G.IHashMap_get_closure.prototype = {
    call$1: function(candidates) {
      var t1 = this.$this,
        t2 = t1.$ti;
      return t2._eval$1("IList<Tuple2<1*,2*>*>*")._as(candidates).find$1(0, new G.IHashMap_get__closure(t1, this.k)).map$1$1(0, new G.IHashMap_get__closure0(t1), t2._eval$1("2*"));
    },
    $signature: function() {
  ...
  G.IHashMap_put_closure.prototype = {
    call$1: function(existing) {
      var t1 = this.$this,
        t2 = t1.$ti,
        t3 = this.k;
      return new G.Cons(new G.Tuple2(t3, this.v, t2._eval$1("@<1*>")._bind$1(t2._eval$1("2*"))._eval$1("Tuple2<1,2>")), t2._eval$1("IList<Tuple2<1*,2*>*>*")._as(existing).filter$1(0, new G.IHashMap_put__closure(t1, t3)), t2._eval$1("Cons<Tuple2<1*,2*>*>"));
    },
    $signature: function() {
  ...
  G.IHashMap_toMap_closure.prototype = {
    call$3: function(p, k, v) {
      ...
      J.$indexSet$ax(p, t1._eval$1("1*")._as(k), t1._eval$1("2*")._as(v));
      return p;
    },
    $signature: function() {
  ...
  G.IHashMap_foldLeftKV_closure.prototype = {
    call$2: function(prev, kvs) {
      ...
      t2._as(prev);
      t3 = this.$this;
      return t3.$ti._eval$1("IList<Tuple2<1*,2*>*>*")._as(kvs).foldLeft$1$2(prev, new G.IHashMap_foldLeftKV__closure(t3, this.f, t1), t2);
    },
    $signature: function() {
  ...
  G.IHashMap_foldLeft_closure.prototype = {
    call$2: function(prev, kvs) {
      ...
      t2._as(prev);
      t3 = this.$this;
      return t3.$ti._eval$1("IList<Tuple2<1*,2*>*>*")._as(kvs).foldLeft$1$2(prev, new G.IHashMap_foldLeft__closure(t3, this.f, t1), t2);
    },
    $signature: function() {
      return this.$this.$ti._bind$1(this.B)._eval$1("1*(1*,IList<Tuple2<2*,3*>*>*)");
    }
  ...
  G.IHashMap_foldLeft__closure.prototype = {
    call$2: function(pprev, kv) {
      return this.f.call$2(this.B._eval$1("0*")._as(pprev), this.$this.$ti._eval$1("Tuple2<1*,2*>*")._as(kv).value2);
    },
    $signature: function() {
      return this.$this.$ti._bind$1(this.B)._eval$1("1*(1*,Tuple2<2*,3*>*)");
    }
  ...
  G.IHashMap_toString_closure.prototype = {
    call$1: function(kvs) {
      var t1 = this.$this;
      return t1.$ti._eval$1("IList<Tuple2<1*,2*>*>*")._as(kvs).map$1$1(0, new G.IHashMap_toString__closure(t1), type$.legacy_String);
    },
    $signature: function() {
  ...
  G.IHashMap_pairIterable_closure.prototype = {
    call$1: function(tuples) {
      ...
      tuples.toString;
      return new G._IListIterable(tuples, H._instanceType(tuples)._eval$1("_IListIterable<IList.A*>"));
    },
    $signature: function() {
  ...
  G.IList.prototype = {
    map$1$1: function(_, f, $B) {
      ...
      H._instanceType(_this)._bind$1($B)._eval$1("1*(IList.A*)*")._as(f);
    ...
    foldLeft$1$2: function(z, f, $B) {
      var result, current;
      $B._eval$1("0*")._as(z);
      H._instanceType(this)._bind$1($B)._eval$1("1*(1*,IList.A*)*")._as(f);
    ...
    foldRight$1$2: function(z, f, $B) {
      var t1 = $B._eval$1("0*");
      t1._as(z);
      H._instanceType(this)._bind$1($B)._eval$1("1*(IList.A*,1*)*")._as(f);
      return this.reverse$0(0).foldLeft$1$2(z, new G.IList_foldRight_closure(this, f, $B), t1);
    },
    reverse$0: function(_) {
      var t1 = H._instanceType(this);
      return this.foldLeft$1$2(new G.Nil(t1._eval$1("Nil<IList.A*>")), new G.IList_reverse_closure(this), t1._eval$1("IList<IList.A*>*"));
    },
    plus$1: function(l2) {
      var t1 = H._instanceType(this)._eval$1("IList<IList.A*>*");
    ...
    filter$1: function(_, predicate) {
      var rresult, current, currentHead,
        t1 = H._instanceType(this);
      t1._eval$1("bool*(IList.A*)*")._as(predicate);
      rresult = new G.Nil(t1._eval$1("Nil<IList.A*>"));
      for (t1 = t1._eval$1("Cons<IList.A*>"), current = this; current._isCons$0();) {
    ...
    find$1: function(_, predicate) {
      ...
      for (current = this; current._isCons$0();) {
        currentHead = current._unsafeHead$0();
        if (H.boolConversionCheck(predicate.call$1(currentHead)))
          return new G.Some(currentHead, t1._eval$1("Some<IList.A*>"));
        current = current._unsafeTail$0();
      }
      return new G.None(t1._eval$1("None<IList.A*>"));
    },
    toString$0: function(_) {
      return C.JSString_methods.$add("ilist[", this.map$1$1(0, new G.IList_toString_closure(this), type$.legacy_String).intercalate$2($.$get$StringMi(), ", ")) + "]";
    },
    $eq: function(_, other) {
    ...
    get$hashCode: function(_) {
      return this.foldLeft$1$2(0, new G.IList_hashCode_closure(this), type$.legacy_int);
    },
    intercalate$2: function(mi, a) {
      var t1 = H._instanceType(this);
      t1._eval$1("Monoid<IList.A*>*")._as(mi);
      t1 = this.foldRight$1$2(new G.None(t1._eval$1("None<IList.A*>")), new G.IList_intercalate_closure(this, mi, t1._eval$1("IList.A*")._as(a)), t1._eval$1("Option<IList.A*>*"));
      mi.toString;
      return J.$or$n(t1, "");
    },
    length$0: function(_) {
      return this.foldLeft$1$2(0, new G.IList_length_closure(this), type$.legacy_int);
    },
    iterator$0: function(_) {
      return new G._IListIterator(this, H._instanceType(this)._eval$1("_IListIterator<IList.A*>"));
    }
  };
  G.IList_foldRight_closure.prototype = {
    call$2: function(a, b) {
      this.B._eval$1("0*")._as(a);
      return this.f.call$2(H._instanceType(this.$this)._eval$1("IList.A*")._as(b), a);
    },
    $signature: function() {
      return H._instanceType(this.$this)._bind$1(this.B)._eval$1("1*(1*,IList.A*)");
    }
  };
  G.IList_reverse_closure.prototype = {
    call$2: function(a, h) {
      var t1 = H._instanceType(this.$this);
      t1._eval$1("IList<IList.A*>*")._as(a);
      return new G.Cons(t1._eval$1("IList.A*")._as(h), a, t1._eval$1("Cons<IList.A*>"));
    },
    $signature: function() {
      return H._instanceType(this.$this)._eval$1("Cons<IList.A*>*(IList<IList.A*>*,IList.A*)");
    }
  };
  G.IList_plus_closure.prototype = {
    call$2: function(e, p) {
      var t1 = H._instanceType(this.$this);
      return new G.Cons(t1._eval$1("IList.A*")._as(e), t1._eval$1("IList<IList.A*>*")._as(p), t1._eval$1("Cons<IList.A*>"));
    },
    $signature: function() {
      return H._instanceType(this.$this)._eval$1("Cons<IList.A*>*(IList.A*,IList<IList.A*>*)");
    }
  };
  G.IList_toString_closure.prototype = {
    call$1: function(a) {
      return J.toString$0$(H._instanceType(this.$this)._eval$1("IList.A*")._as(a));
    },
    $signature: function() {
      return H._instanceType(this.$this)._eval$1("String*(IList.A*)");
    }
  };
  G.IList_hashCode_closure.prototype = {
    call$2: function(hash, a) {
      var t1;
      H._asIntS(hash);
      t1 = J.get$hashCode$(H._instanceType(this.$this)._eval$1("IList.A*")._as(a));
    ...
    $signature: function() {
      return H._instanceType(this.$this)._eval$1("int*(int*,IList.A*)");
    }
  };
  G.IList_intercalate_closure.prototype = {
    call$2: function(ca, oa) {
      var t3,
        ...
        t2 = t1._eval$1("IList.A*");
      t2._as(ca);
      t3 = this.mi;
      t2 = t1._eval$1("Option<IList.A*>*")._as(oa).fold$1$2(0, t3.get$zero(), t1._eval$1("IList.A*(IList.A*)*")._as(t3.appendC$1(this.a)), t2);
      return new G.Some(J.$add$ansx(H._asStringS(ca), H._asStringS(t2)), t1._eval$1("Some<IList.A*>"));
    },
    $signature: function() {
      return H._instanceType(this.$this)._eval$1("Option<IList.A*>*(IList.A*,Option<IList.A*>*)");
    }
  };
  G.IList_length_closure.prototype = {
    call$2: function(a, b) {
      H._asIntS(a);
      H._instanceType(this.$this)._eval$1("IList.A*")._as(b);
      if (typeof a !== "number")
        return a.$add();
      return a + 1;
    },
  ...
  G._IListIterator.prototype = {
    ...
    set$_dartz$_current: function(_current) {
      this._dartz$_current = this.$ti._eval$1("1*")._as(_current);
    }
  };
  G.IMap.prototype = {
    $index: function(_, k) {
      return this._tree.$get$2(0, this._order, this.$ti._eval$1("1*")._as(k));
    },
    modify$3: function(_, k, f, dflt) {
      var t1 = this.$ti,
        t2 = t1._eval$1("2*"),
        t3 = this._order;
      return new G.IMap(t3, this._tree.modify$4(0, t3, t1._eval$1("1*")._as(k), t1._eval$1("2*(2*)*")._as(f), t2._as(dflt)), t1._eval$1("@<1*>")._bind$1(t2)._eval$1("IMap<1,2>"));
    },
    values$0: function(_) {
      var t1 = this.$ti;
    ...
    foldMapKV$1$2: function(mi, f, $B) {
      ...
      return this._tree.foldLeft$1$2(new G.Nil(mi.$ti._eval$1("Nil<1*>")), new G.IMap_foldMapKV_closure(this, mi, this.$ti._bind$1($B)._eval$1("1*(2*,3*)*")._as(f), $B), $B._eval$1("0*"));
    },
    pairs$0: function() {
      var t1 = this.$ti;
    ...
    foldMap$1$2: function(bMonoid, f, $B) {
      ...
      bMonoid.toString;
      return this._tree.foldLeft$1$2(new G.Nil(bMonoid.$ti._eval$1("Nil<1*>")), new G.IMap_foldMap_closure(this, bMonoid, f, $B), $B._eval$1("0*"));
    },
    foldLeft$1$2: function(z, f, $B) {
      var t1 = $B._eval$1("0*");
      return this._tree.foldLeft$1$2(t1._as(z), new G.IMap_foldLeft_closure(this, this.$ti._bind$1($B)._eval$1("1*(1*,3*)*")._as(f), $B), t1);
    },
    foldRight$1$2: function(z, f, $B) {
      var t1 = $B._eval$1("0*");
      return this._tree.foldRight$1$2(t1._as(z), new G.IMap_foldRight_closure(this, this.$ti._bind$1($B)._eval$1("1*(3*,1*)*")._as(f), $B), t1);
    },
    $eq: function(_, other) {
      var t1, t2, _this = this;
      if (other == null)
      ...
      if (_this !== other)
        if (other instanceof G.IMap)
          if (_this._order == other._order) {
            t1 = _this.$ti;
            t1 = new G._IMapPairIterable(_this, t1._eval$1("@<1*>")._bind$1(t1._eval$1("2*"))._eval$1("_IMapPairIterable<1,2>"));
            t2 = other.$ti;
            t2 = new G._IMapPairIterable(other, t2._eval$1("@<1*>")._bind$1(t2._eval$1("2*"))._eval$1("_IMapPairIterable<1,2>"));
    ...
    toString$0: function(_) {
      return "imap{" + H.S(this.foldMapKV$1$2(new G.IListMonoid(type$.IListMonoid_legacy_String), new G.IMap_toString_closure(this), type$.legacy_IList_legacy_String).intercalate$2($.$get$StringMi(), ", ")) + "}";
    },
    length$0: function(_) {
      return this.foldLeft$1$2(0, new G.IMap_length_closure(this), type$.legacy_int);
    },
    iterator$0: function(_) {
      var t1 = this.$ti;
      t1 = new G._IMapPairIterable(this, t1._eval$1("@<1*>")._bind$1(t1._eval$1("2*"))._eval$1("_IMapPairIterable<1,2>"));
  ...
  G.IMap_values_closure.prototype = {
    call$3: function(k, v, p) {
      var t1 = this.$this.$ti;
      t1._eval$1("1*")._as(k);
      return new G.Cons(t1._eval$1("2*")._as(v), t1._eval$1("IList<2*>*")._as(p), t1._eval$1("Cons<2*>"));
    },
    $signature: function() {
  ...
  G.IMap_foldMapKV_closure.prototype = {
    call$3: function(p, k, v) {
      var t1, t2, _this = this;
      _this.B._eval$1("0*")._as(p);
      t1 = _this.$this.$ti;
      t1 = _this.f.call$2(t1._eval$1("1*")._as(k), t1._eval$1("2*")._as(v));
  ...
  G.IMap_pairs_closure.prototype = {
    call$3: function(k, v, p) {
      var t1 = this.$this.$ti,
        t2 = t1._eval$1("2*");
      return new G.Cons(new G.Tuple2(t1._eval$1("1*")._as(k), t2._as(v), t1._eval$1("@<1*>")._bind$1(t2)._eval$1("Tuple2<1,2>")), t1._eval$1("IList<Tuple2<1*,2*>*>*")._as(p), t1._eval$1("Cons<Tuple2<1*,2*>*>"));
    },
    $signature: function() {
  ...
  G.IMap_foldMap_closure.prototype = {
    call$3: function(p, k, v) {
      ...
      t1 = _this.$this.$ti;
      t1._eval$1("1*")._as(k);
      t1 = _this.f.call$1(t1._eval$1("2*")._as(v));
  ...
  G.IMap_foldLeft_closure.prototype = {
    call$3: function(p, k, v) {
      var t1;
      this.B._eval$1("0*")._as(p);
      t1 = this.$this.$ti;
      t1._eval$1("1*")._as(k);
      return this.f.call$2(p, t1._eval$1("2*")._as(v));
    },
    $signature: function() {
      return this.$this.$ti._bind$1(this.B)._eval$1("1*(1*,2*,3*)");
    }
  ...
  G.IMap_foldRight_closure.prototype = {
    call$3: function(k, v, p) {
      var t1 = this.$this.$ti;
      t1._eval$1("1*")._as(k);
      return this.f.call$2(t1._eval$1("2*")._as(v), this.B._eval$1("0*")._as(p));
    },
    $signature: function() {
  ...
  G.IMap_toString_closure.prototype = {
    call$2: function(k, v) {
      ...
      t1._eval$1("1*")._as(k);
      t1._eval$1("2*")._as(v);
      return new G.Cons(H.S(k) + ": " + H.S(v), new G.Nil(type$.Nil_legacy_String), type$.Cons_legacy_String);
    },
    $signature: function() {
  ...
  G._NonEmptyIMapAVLNode.prototype = {
    ...
    _rebalance$0: function() {
      ...
      if (b < -1)
        if (t2.get$balance() < 0)
          ...
          t1 = _this.$ti._eval$1("_NonEmptyIMapAVLNode<1*,2*>*")._as(t2._unsafeGetNonEmpty$0());
        ...
        if (t1.get$balance() > 0)
          ...
          t1 = _this.$ti._eval$1("_NonEmptyIMapAVLNode<1*,2*>*")._as(t1._unsafeGetNonEmpty$0());
    ...
    llRotate$1: function(l) {
      var t2, _this = this,
        t1 = _this.$ti;
      t1._eval$1("_NonEmptyIMapAVLNode<1*,2*>*")._as(l);
      t2 = t1._eval$1("1*");
      t1 = t1._eval$1("2*");
    ...
    rrRotate$1: function(r) {
      var t2, _this = this,
        t1 = _this.$ti;
      t1._eval$1("_NonEmptyIMapAVLNode<1*,2*>*")._as(r);
      t2 = t1._eval$1("1*");
      t1 = t1._eval$1("2*");
    ...
    foldLeft$1$2: function(z, f, $B) {
      ...
      return _this._right.foldLeft$1$2(f.call$3(_this._left.foldLeft$1$2(z, f, t1), _this._k, _this._v), f, t1);
    },
    foldRight$1$2: function(z, f, $B) {
      var _this = this,
        t1 = $B._eval$1("0*");
      ...
      return _this._left.foldRight$1$2(f.call$3(_this._k, _this._v, _this._right.foldRight$1$2(z, f, t1)), f, t1);
    },
    ...
    map$1$1: function(_, f, V2) {
      var t2, newLeft, _this = this,
        t1 = _this.$ti;
      t1._bind$1(V2)._eval$1("1*(3*)*")._as(f);
      t2 = V2._eval$1("0*");
      newLeft = _this._left.map$1$1(0, f, t2);
      return G._NonEmptyIMapAVLNode$(_this._k, f.call$1(_this._v), newLeft, _this._right.map$1$1(0, f, t2), t1._eval$1("1*"), t2);
    },
  ...
  G._EmptyIMapAVLNode.prototype = {
    ...
    map$1$1: function(_, f, V2) {
      var t1 = this.$ti;
      t1._bind$1(V2)._eval$1("1*(3*)*")._as(f);
      return new G._EmptyIMapAVLNode(t1._eval$1("@<1*>")._bind$1(V2._eval$1("0*"))._eval$1("_EmptyIMapAVLNode<1,2>"));
    },
    $eq: function(_, other) {
      if (other == null)
        return false;
  ...
  G._IMapPairIterator.prototype = {
    get$current: function(_) {
      ...
      if (t1 != null) {
        t2 = this.$ti;
        t2 = new G.Tuple2(t1._k, t1._v, t2._eval$1("@<1*>")._bind$1(t2._eval$1("2*"))._eval$1("Tuple2<1,2>"));
        t1 = t2;
      } else
        t1 = null;
      return t1;
  ...
  G.IVector.prototype = {
    $index: function(_, i) {
      ...
      return t1._tree.$get$2(0, t1._order, t1.$ti._eval$1("1*")._as(this._dartz$_offset + H._asIntS(i)));
    },
    length$0: function(_) {
    ...
    $eq: function(_, other) {
      ...
      if (this !== other)
        if (other instanceof G.IVector) {
          ...
          t3 = t2.$ti;
          t3 = new G._IMapValueIterable(t2, t3._eval$1("@<1*>")._bind$1(t3._eval$1("2*"))._eval$1("_IMapValueIterable<1,2>"));
          t3 = t3.get$iterator(t3);
          t2 = other._elementsByIndex;
          t4 = t2.$ti;
          t4 = new G._IMapValueIterable(t2, t4._eval$1("@<1*>")._bind$1(t4._eval$1("2*"))._eval$1("_IMapValueIterable<1,2>"));
    ...
    toString$0: function(_) {
      var _this = this,
        ...
        t2 = t1.$ti;
      return "ivector[" + H.S(new G.IVector(new G.IMap(t1._order, t1._tree.map$1$1(0, t2._eval$1("String*(2*)*")._as(_this.$ti._eval$1("String*(1*)*")._as(new G.IVector_toString_closure(_this))), type$.legacy_String), t2._eval$1("IMap<1*,String*>")), _this._dartz$_offset, _this._dartz$_length, type$.IVector_legacy_String).intercalate$2($.$get$StringMi(), ", ")) + "]";
    },
    intercalate$2: function(mi, a) {
      var t2,
        t1 = this.$ti;
    ...
    iterator$0: function(_) {
      var t1 = this._elementsByIndex,
        t2 = t1.$ti;
      t2 = new G._IMapValueIterable(t1, t2._eval$1("@<1*>")._bind$1(t2._eval$1("2*"))._eval$1("_IMapValueIterable<1,2>"));
  ...
  G.IVector_IVector$from_closure.prototype = {
    call$2: function(p, a) {
      ...
      t6 = t5._eval$1("2*");
      t7 = t2._order;
      return new G.IVector(new G.IMap(t7, t2._tree.insert$3(0, t7, t5._eval$1("1*")._as(t3 + t4), t6._as(a)), t5._eval$1("@<1*>")._bind$1(t6)._eval$1("IMap<1,2>")), t3, t4 + 1, t1._eval$1("IVector<1*>"));
    },
    $signature: function() {
  ...
  G.IVector_toString_closure.prototype = {
    call$1: function(a) {
      return J.toString$0$(this.$this.$ti._eval$1("1*")._as(a));
    },
    $signature: function() {
  ...
  G.IVector_intercalate_closure.prototype = {
    call$2: function(ca, oa) {
      ...
      return new G.Some(J.$add$ansx(H._asStringS(ca), H._asStringS(t2)), t1._eval$1("Some<1*>"));
    },
    $signature: function() {
  ...
  G.Option.prototype = {
    getOrElse$1: function(dflt) {
      var t1 = H._instanceType(this);
      return this.fold$1$2(0, t1._eval$1("Option.A*()*")._as(dflt), new G.Option_getOrElse_closure(this), t1._eval$1("Option.A*"));
    },
    $or: function(_, dflt) {
      return this.getOrElse$1(new G.Option_operator$or_closure(this, H._instanceType(this)._eval$1("Option.A*")._as(dflt)));
    },
    map$1$1: function(_, f, $B) {
      return this.fold$1$2(0, H.instantiate1(G.dartz__none$closure(), $B._eval$1("0*")), new G.Option_map_closure(this, H._instanceType(this)._bind$1($B)._eval$1("1*(Option.A*)*")._as(f), $B), $B._eval$1("Option<0*>*"));
    },
    length$0: function(_) {
      return this.fold$1$2(0, new G.Option_length_closure(), new G.Option_length_closure0(this), type$.legacy_int);
    },
    isSome$0: function() {
      return this.fold$1$2(0, new G.Option_isSome_closure(), new G.Option_isSome_closure0(this), type$.legacy_bool);
    },
    toString$0: function(_) {
      return this.fold$1$2(0, new G.Option_toString_closure(), new G.Option_toString_closure0(this), type$.legacy_String);
    },
    toIterable$0: function() {
      return this.fold$1$2(0, new G.Option_toIterable_closure(), new G.Option_toIterable_closure0(this), H._instanceType(this)._eval$1("Iterable<Option.A*>*"));
    },
    iterator$0: function(_) {
  ...
  G.Option_getOrElse_closure.prototype = {
    call$1: function(a) {
      return H._instanceType(this.$this)._eval$1("Option.A*")._as(a);
    },
    $signature: function() {
      return H._instanceType(this.$this)._eval$1("Option.A*(Option.A*)");
    }
  };
  G.Option_operator$or_closure.prototype = {
    ...
    $signature: function() {
      return H._instanceType(this.$this)._eval$1("Option.A*()");
    }
  };
  G.Option_map_closure.prototype = {
    call$1: function(a) {
      return new G.Some(this.f.call$1(H._instanceType(this.$this)._eval$1("Option.A*")._as(a)), this.B._eval$1("Some<0*>"));
    },
    $signature: function() {
      return H._instanceType(this.$this)._bind$1(this.B)._eval$1("Option<1*>*(Option.A*)");
    }
  };
  ...
  G.Option_length_closure0.prototype = {
    call$1: function(_) {
      H._instanceType(this.$this)._eval$1("Option.A*")._as(_);
      return 1;
    },
    $signature: function() {
      return H._instanceType(this.$this)._eval$1("int*(Option.A*)");
    }
  };
  ...
  G.Option_isSome_closure0.prototype = {
    ...
    $signature: function() {
      return H._instanceType(this.$this)._eval$1("bool*(Option.A*)");
    }
  };
  ...
  G.Option_toString_closure0.prototype = {
    call$1: function(a) {
      return "Some(" + H.S(H._instanceType(this.$this)._eval$1("Option.A*")._as(a)) + ")";
    },
    $signature: function() {
      return H._instanceType(this.$this)._eval$1("String*(Option.A*)");
    }
  };
  ...
  G.Option_toIterable_closure0.prototype = {
    call$1: function(a) {
      var t1 = H._instanceType(this.$this);
      return new G._SingletonIterable(t1._eval$1("Option.A*")._as(a), t1._eval$1("_SingletonIterable<Option.A*>"));
    },
    $signature: function() {
      return H._instanceType(this.$this)._eval$1("_SingletonIterable<Option.A*>*(Option.A*)");
    }
  };
  G.Some.prototype = {
  ...
  X.ParsedPath.prototype = {
    ...
    normalize$0: function(_) {
      ...
      if (_this.root == null) {
        iterable = type$.Iterable_legacy_String._as(P.List_List$filled(leadingDoubles, "..", false, type$.legacy_String));
  ...
  U.ASTNode.prototype = {
    ...
    showValue$1: function(value) {
      var t1;
      if (type$.legacy_List_dynamic._is(value)) {
  ...
  U.ASTNode_toString_closure.prototype = {
    call$1: function(s) {
      return H._asStringS(s).length !== 0;
    },
    $signature: 6
  };
  D.checkArity_closure.prototype = {
    call$1: function(arg) {
      return J.get$runtimeType$u(type$.legacy_PtlsValue._as(arg));
    },
    $signature: 31
  };
  Q.Env.prototype = {
    valuesMap$0: function() {
      var t2, t3,
        t1 = P.LinkedHashMap_LinkedHashMap$_empty(type$.legacy_String, type$.legacy_PtlsValue);
    ...
    clone$0: function(_) {
      var t2, t3,
        ...
        t1 = P.LinkedHashMap_LinkedHashMap$_empty(type$.legacy_String, type$.legacy_Thunk);
    ...
    addDef$1: function(defNode) {
      ...
      if (t1 === C.Node_15) {
        ...
        if (0 >= t1.length)
          return H.ioore(t1, 0);
        this.addDefName$2(H._asStringS(t1[0]), rhs);
        return;
      }
      if (t1 === C.Node_26) {
        t1 = lhs.values;
        if (0 >= t1.length)
          return H.ioore(t1, 0);
        this.addDefTuple$2(type$.legacy_List_legacy_ASTNode._as(t1[0]), rhs);
        return;
      }
      throw H.wrapException(false);
    },
    addDefThunk$1: function(thunk) {
      ...
      if (this.defs.containsKey$1(0, t1)) {
        error = new S.PtlsError("Name Error", P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
    ...
    addDefTuple$2: function(members, rhs) {
      ...
      type$.legacy_List_legacy_ASTNode._as(members);
      ...
      for (t1 = J.get$iterator$ax(members), index = 0; t1.moveNext$0();) {
        ...
        if (0 >= t2.length)
          return H.ioore(t2, 0);
        this.addDefThunk$1(new A.Thunk(H._asStringS(t2[0]), new Q.Env_addDefTuple_closure(tupleThunk, index)));
        ++index;
      }
    },
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                try {
                  ...
                  if (t1 instanceof L.PtlsException) {
                    exc = t1;
                    error = new S.PtlsError("Exception Error", P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
              ...
              case 5:
                ...
                if (t1 instanceof L.PtlsException) {
                  exc0 = t1;
                  error0 = new S.PtlsError("Exception Error", P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
    ...
    set$defs: function(defs) {
      this.defs = type$.legacy_Map_of_legacy_String_and_legacy_Thunk._as(defs);
    }
  };
  ...
  Q.Env_addDefTuple_func.prototype = {
    call$0: function() {
      var t2, error,
        t1 = H.setRuntimeTypeInfo([C.Type_PtlsTuple_ynv], type$.JSArray_legacy_Type),
        tuple = type$.legacy_PtlsTuple._as(A.$eval(this.$this, this.rhs).checkType$1(t1));
      t1 = J.get$length$asx(this.members);
      t2 = tuple.members;
      if (t1 !== t2.length) {
        error = new S.PtlsError("Type Error", P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
  ...
  A.dispatch_closure.prototype = {
    call$0: function() {
      return A.$eval(this._box_0.env, type$.legacy_ASTNode._as(this.el));
    },
    "call*": "call$0",
    $requiredArgCount: 0,
    $signature: 2
  ...
  G.Parser.prototype = {
    ...
    wrongToken$2: function(expected, got) {
      ...
      type$.legacy_List_legacy_Tok._as(expected);
      t1 = P.LinkedHashSet_LinkedHashSet(type$.legacy_Location);
    ...
    isNext$2: function(testTypes, skip) {
      var t2, t3, cur,
        t1 = type$.legacy_List_legacy_Tok;
      t1._as(testTypes);
      t1._as(skip);
      t1 = this.tokens;
      t2 = this.index;
      ...
      for (; t1.moveNext$0();) {
        cur = t1.__internal$_current;
        if (C.JSArray_methods.contains$1(testTypes, cur.tokType))
          return true;
        if (!C.JSArray_methods.contains$1(skip, cur.tokType))
          return false;
      }
      return false;
    },
    ...
    isNextMulti$2: function(testTypes, skip) {
      var tokenQueue, t2, t3, cur,
        t1 = type$.legacy_List_legacy_Tok;
      t1._as(testTypes);
      t1._as(skip);
      tokenQueue = new P.ListQueue(P.List_List$filled(P.ListQueue__calculateCapacity(null), null, false, type$.nullable_Tok), type$.ListQueue_legacy_Tok);
      ...
      for (; t1.moveNext$0();) {
        ...
        } else if (!C.JSArray_methods.contains$1(skip, cur.tokType))
          return false;
      }
      return false;
    },
    ...
    peek$1: function(testTypes) {
      var oldIndex, token;
      type$.legacy_List_legacy_Tok._as(testTypes);
      oldIndex = this.index;
    ...
    getSeq$5: function(start, end, sep, handler, allowTrailSep) {
      ...
      type$.legacy_legacy_ASTNode_Function._as(handler);
      t1 = type$.JSArray_legacy_Tok;
      _this.getNext$1(H.setRuntimeTypeInfo([start], t1));
      result = H.setRuntimeTypeInfo([], type$.JSArray_legacy_ASTNode);
    ...
    getName$0: function() {
      var token = this.getNext$1(H.setRuntimeTypeInfo([C.Tok_39], type$.JSArray_legacy_Tok));
      return new U.ASTNode(C.Node_15, token.loc, [token.value]);
    },
    getString$0: function(_) {
      var token = this.getNext$1(H.setRuntimeTypeInfo([C.Tok_54], type$.JSArray_legacy_Tok)),
        t1 = token.value,
        t2 = t1.length;
    ...
    getLabel$0: function() {
      ...
      if (_this.isNext$1(H.setRuntimeTypeInfo([C.Tok_34], t1)))
        return _this.makeCall$2(new U.ASTNode(C.Node_9, t2, [label, new U.ASTNode(C.Node_15, t2, ["!getWrapTuple"])]), H.setRuntimeTypeInfo([_this.getTuple$0()], type$.JSArray_legacy_ASTNode));
      if (_this.isNext$1(H.setRuntimeTypeInfo([C.Tok_31], t1)))
        return _this.makeCall$2(new U.ASTNode(C.Node_9, t2, [label, new U.ASTNode(C.Node_15, t2, ["!getWrapObject"])]), H.setRuntimeTypeInfo([_this.getObject$0(0)], type$.JSArray_legacy_ASTNode));
      return label;
    },
    getList$0: function() {
      return new U.ASTNode(C.Node_14, this.peek$1(H.setRuntimeTypeInfo([C.Tok_30], type$.JSArray_legacy_Tok)).loc, [this.getSeq$5(C.Tok_30, C.Tok_49, C.Tok_10, this.get$getClause(), true)]);
    },
    getArray1D$0: function() {
      return new U.ASTNode(C.Node_0, this.peek$1(H.setRuntimeTypeInfo([C.Tok_30], type$.JSArray_legacy_Tok)).loc, [this.getSeq$5(C.Tok_30, C.Tok_49, C.Tok_63, this.get$getOperation(), true)]);
    },
    getArray2D$0: function() {
      var t2, t3, t4, oldIndex, token, _this = this,
        elems = H.setRuntimeTypeInfo([_this.getArray1D$0()], type$.JSArray_legacy_ASTNode),
        t1 = type$.JSArray_legacy_Tok,
        skip = H.setRuntimeTypeInfo([C.Tok_63, C.Tok_11], t1);
      for (t2 = type$.legacy_List_legacy_Tok, t3 = _this.get$getOperation(); _this.isNextMulti$2(H.setRuntimeTypeInfo([C.Tok_41, C.Tok_30], t1), skip);) {
    ...
    getParenElements$1: function(handler) {
      ...
      type$.legacy_legacy_ASTNode_Function._as(handler);
      t1 = this.peek$1(H.setRuntimeTypeInfo([C.Tok_34], type$.JSArray_legacy_Tok));
      elems = this.getSeq$5(C.Tok_34, C.Tok_52, C.Tok_10, handler, false);
      if (elems.length === 0) {
        t2 = P.LinkedHashSet_LinkedHashSet(type$.legacy_Location);
    ...
    getTuple$0: function() {
      return new U.ASTNode(C.Node_26, this.peek$1(H.setRuntimeTypeInfo([C.Tok_34], type$.JSArray_legacy_Tok)).loc, [this.getParenElements$1(this.get$getClause())]);
    },
    getTupleName$0: function() {
      var t1 = type$.JSArray_legacy_Tok;
    ...
    getObject$0: function(_) {
      var _this = this,
        ...
        defs = H.setRuntimeTypeInfo([], type$.JSArray_legacy_ASTNode);
    ...
    getPair$0: function() {
      ...
      this.getNext$1(H.setRuntimeTypeInfo([C.Tok_9], type$.JSArray_legacy_Tok));
      val = this.getClause$0();
      return new U.ASTNode(C.Node_18, key.loc, [key, val]);
    },
    getDict$0: function() {
      return new U.ASTNode(C.Node_7, this.peek$1(H.setRuntimeTypeInfo([C.Tok_31], type$.JSArray_legacy_Tok)).loc, [this.getSeq$5(C.Tok_31, C.Tok_50, C.Tok_10, this.get$getPair(), true)]);
    },
    getArrayLiteral$0: function() {
      var _this = this,
        oldIndex = _this.index,
        t1 = type$.JSArray_legacy_Tok,
        t2 = _this.getNext$1(H.setRuntimeTypeInfo([C.Tok_30], t1));
      if (_this.isNextMulti$2(H.setRuntimeTypeInfo([C.Tok_63, C.Tok_49], t1), H.setRuntimeTypeInfo([], t1))) {
        _this.getNext$1(H.setRuntimeTypeInfo([C.Tok_63], t1));
        _this.getNext$1(H.setRuntimeTypeInfo([C.Tok_49], t1));
        return new U.ASTNode(C.Node_0, t2.loc, [[]]);
      }
      if (_this.isNextMulti$1(H.setRuntimeTypeInfo([C.Tok_49], t1))) {
        _this.index = oldIndex;
    ...
    getBracketLiteral$0: function() {
      var oldIndex, loc, _this = this,
        t1 = type$.JSArray_legacy_Tok;
      if (_this.isNextMulti$1(H.setRuntimeTypeInfo([C.Tok_31, C.Tok_50], t1)))
        return _this.getDict$0();
      oldIndex = _this.index;
      loc = _this.getNext$1(H.setRuntimeTypeInfo([C.Tok_31], t1)).loc;
      if (_this.isNextMulti$2(H.setRuntimeTypeInfo([C.Tok_10, C.Tok_50], t1), H.setRuntimeTypeInfo([], t1))) {
        _this.getNext$1(H.setRuntimeTypeInfo([C.Tok_10], t1));
        _this.getNext$1(H.setRuntimeTypeInfo([C.Tok_50], t1));
        return new U.ASTNode(C.Node_22, loc, [[]]);
      }
      if (_this.isNextMulti$2(H.setRuntimeTypeInfo([C.Tok_53, C.Tok_50], t1), H.setRuntimeTypeInfo([], t1))) {
        _this.getNext$1(H.setRuntimeTypeInfo([C.Tok_53], t1));
        _this.getNext$1(H.setRuntimeTypeInfo([C.Tok_50], t1));
        return new U.ASTNode(C.Node_17, loc, [[]]);
      }
      _this.getClause$0();
    ...
    getFieldRef$1: function(lhs) {
      var token = this.getNext$1(H.setRuntimeTypeInfo([C.Tok_21], type$.JSArray_legacy_Tok)),
        t1 = token.loc;
      return new U.ASTNode(C.Node_9, t1, [lhs, new U.ASTNode(C.Node_15, t1, [C.JSString_methods.substring$1(token.value, 1)])]);
    },
    makeCall$2: function(func, args) {
      var t1, result, _i, arg;
      for (t1 = args.length, result = func, _i = 0; _i < args.length; args.length === t1 || (0, H.throwConcurrentModificationError)(args), ++_i) {
        arg = args[_i];
        result = new U.ASTNode(C.Node_4, arg.get$loc(), [result, arg]);
      }
      return result;
    },
    getUnit$0: function() {
      var oldIndex, token, t4, rhs, _this = this,
        ...
        t2 = _this.get$getClause(),
        t3 = type$.legacy_List_legacy_Tok;
      while (true) {
        ...
        switch (token.tokType) {
          ...
          case C.Tok_21:
            ...
            break;
          case C.Tok_34:
            lhs = _this.makeCall$2(lhs, _this.getParenElements$1(t2));
            break;
          default:
            throw H.wrapException(false);
        }
    ...
    getBinaryOp$1: function(precedence) {
      var lhs, opEntry, increment, token, rhs, t3, _this = this,
        t1 = type$.JSArray_legacy_Tok,
        t2 = type$.JSArray_legacy_Object,
        opEntries = [H.setRuntimeTypeInfo([true, H.setRuntimeTypeInfo([C.Tok_46], t1)], t2), H.setRuntimeTypeInfo([false, H.setRuntimeTypeInfo([C.Tok_12], t1)], t2), H.setRuntimeTypeInfo([true, H.setRuntimeTypeInfo([C.Tok_45], t1)], t2), H.setRuntimeTypeInfo([true, H.setRuntimeTypeInfo([C.Tok_2], t1)], t2), H.setRuntimeTypeInfo([true, H.setRuntimeTypeInfo([C.Tok_19, C.Tok_43], t1)], t2), H.setRuntimeTypeInfo([true, H.setRuntimeTypeInfo([C.Tok_27], t1)], t2), H.setRuntimeTypeInfo([true, H.setRuntimeTypeInfo([C.Tok_33, C.Tok_32, C.Tok_24, C.Tok_23], t1)], t2), H.setRuntimeTypeInfo([true, H.setRuntimeTypeInfo([C.Tok_0, C.Tok_55], t1)], t2), H.setRuntimeTypeInfo([true, H.setRuntimeTypeInfo([C.Tok_37, C.Tok_14, C.Tok_35], t1)], t2), H.setRuntimeTypeInfo([false, H.setRuntimeTypeInfo([C.Tok_47], t1)], t2)];
      if (precedence === 10)
      ...
      for (t1 = type$.legacy_List_legacy_Tok, t2 = type$.JSArray_legacy_ASTNode; _this.isNext$1(t1._as(opEntry[1]));) {
        increment = H._asBoolS(opEntry[0]) ? 1 : 0;
        token = _this.getNext$1(t1._as(opEntry[1]));
        rhs = _this.getBinaryOp$1(precedence + increment);
        t3 = token.tokType;
        lhs = t3 === C.Tok_46 ? _this.makeCall$2(rhs, H.setRuntimeTypeInfo([lhs], t2)) : new U.ASTNode(C.Node_1, token.loc, [t3, lhs, rhs]);
      }
      return lhs;
    },
    ...
    getListComp$0: function() {
      ...
      if (_this.isNext$1(H.setRuntimeTypeInfo([C.Tok_22], t1))) {
        ...
        t1 = type$.JSArray_legacy_ASTNode;
        return _this.makeCall$2(new U.ASTNode(C.Node_15, loc, ["concatMap"]), H.setRuntimeTypeInfo([new U.ASTNode(C.Node_10, loc, [H.setRuntimeTypeInfo([variable], t1), result]), iterable], t1));
      } else if (_this.isNext$1(H.setRuntimeTypeInfo([C.Tok_61], t1))) {
        loc = _this.getNext$1(H.setRuntimeTypeInfo([C.Tok_61], t1)).loc;
        return new U.ASTNode(C.Node_5, loc, [_this.getExpression$0(), _this.getListComp$0(), new U.ASTNode(C.Node_14, loc, [H.setRuntimeTypeInfo([], type$.JSArray_legacy_ASTNode)])]);
      }
      return new U.ASTNode(C.Node_14, _this.getNext$1(H.setRuntimeTypeInfo([C.Tok_65], t1)).loc, [H.setRuntimeTypeInfo([_this.getExpression$0()], type$.JSArray_legacy_ASTNode)]);
    },
    isLambda$0: function() {
    ...
    getExpression$0: function() {
      ...
      if (_this.isNext$1(H.setRuntimeTypeInfo([C.Tok_25], t1))) {
        ...
        params = _this.isNext$1(H.setRuntimeTypeInfo([C.Tok_34], t1)) ? _this.getParenElements$1(_this.get$getName()) : H.setRuntimeTypeInfo([_this.getName$0()], type$.JSArray_legacy_ASTNode);
    ...
    getDefinable$1: function(lhs) {
      ...
      for (t2 = type$.legacy_Location; _this.isNext$1(rhsTokens);)
        if (_this.isNext$1(H.setRuntimeTypeInfo([C.Tok_30], t1))) {
          ...
          if (1 >= t3.length)
            return H.ioore(t3, 1);
          t3 = H._asStringS(J.$index$asx(J.get$values$x(t3[1]), 0));
          if (0 >= t3.length)
            return H.ioore(t3, 0);
          if (t3[0] === "!") {
    ...
    getWithDef$0: function() {
      ...
      for (t2 = new H.LinkedHashMapKeyIterable(compoundToks, H._instanceType(compoundToks)._eval$1("LinkedHashMapKeyIterable<1>")), t2 = t2.get$iterator(t2); t2.moveNext$0();)
        C.JSArray_methods.add$1(t1, t2.__js_helper$_current);
    ...
    getClause$0: function() {
      ...
      for (t2 = type$.JSArray_legacy_ASTNode, t3 = type$.legacy_List_legacy_Tok, t4 = type$.legacy_ASTNode; _this.isNext$1(clauseTokens);) {
        t3._as(clauseTokens);
        t3._as(C.List_oke);
        oldIndex = _this.index;
    ...
    getProgram$0: function() {
      ...
      t2 = type$.JSArray_legacy_ASTNode;
  ...
  T.PtlsArray.prototype = {
    get$elemsList: function() {
      var t2, t3,
        t1 = H.setRuntimeTypeInfo([], type$.JSArray_legacy_PtlsValue);
      for (t2 = this.elems._elementsByIndex, t3 = t2.$ti, t3 = new G._IMapValueIterable(t2, t3._eval$1("@<1*>")._bind$1(t3._eval$1("2*"))._eval$1("_IMapValueIterable<1,2>")), t3 = t3.get$iterator(t3); t3.moveNext$0();) {
        t2 = t3._currentNode;
    ...
    checkIndex$1: function(index) {
      ...
      if (J.getInterceptor$n(index).toInt$0(index) !== index) {
        error = new S.PtlsError(_s11_, P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
    ...
    getIndex$1: function(rhs) {
      var index = this.checkIndex$1(type$.legacy_PtlsNumber._as(rhs.checkType$1(H.setRuntimeTypeInfo([C.Type_PtlsNumber_2Vr], type$.JSArray_legacy_Type))).value),
        t1 = this.elems,
        t2 = t1._elementsByIndex;
      return type$.legacy_PtlsValue._as(type$.legacy_Some_dynamic._as(t2._tree.$get$2(0, t2._order, t2.$ti._eval$1("1*")._as(t1._dartz$_offset + index)))._a);
    },
    updateIndex$2: function(index, result) {
      var t2, t3, t4, t5, t6, t7, t8, newTree,
        ind = this.checkIndex$1(type$.legacy_PtlsNumber._as(index.checkType$1(H.setRuntimeTypeInfo([C.Type_PtlsNumber_2Vr], type$.JSArray_legacy_Type))).value),
        t1 = this.elems;
      t1.toString;
      t2 = t1.$ti;
      t2._eval$1("1*")._as(result);
      ...
      t7 = t3._tree;
      t8 = t3._order;
      newTree = t7.setIfPresent$3(t8, t5._eval$1("1*")._as(t4 + ind), t6._as(result));
      t3 = t7 === newTree ? t3 : new G.IMap(t8, newTree, t5._eval$1("@<1*>")._bind$1(t6)._eval$1("IMap<1,2>"));
      return new T.PtlsArray(new G.IVector(t3, t4, t1._dartz$_length, t2._eval$1("IVector<1*>")));
    },
    getField$2: function($name, loc) {
      ...
      switch ($name) {
        case "!getList":
          ...
          t2 = t1.$ti;
          return X.PtlsList_fromValues(new G._IMapValueIterable(t1, t2._eval$1("@<1*>")._bind$1(t2._eval$1("2*"))._eval$1("_IMapValueIterable<1,2>")));
        case "!getTuple":
          t1 = H.setRuntimeTypeInfo([], type$.JSArray_legacy_PtlsValue);
          for (t2 = _this.elems._elementsByIndex, t3 = t2.$ti, t3 = new G._IMapValueIterable(t2, t3._eval$1("@<1*>")._bind$1(t3._eval$1("2*"))._eval$1("_IMapValueIterable<1,2>")), t3 = t3.get$iterator(t3); t3.moveNext$0();) {
            t2 = t3._currentNode;
            C.JSArray_methods.add$1(t1, t2 != null ? t2._v : null);
          }
  ...
  O.PtlsDict.prototype = {
    ...
    getIndex$1: function(rhs) {
      var result, error,
        t1 = this.map;
      t1.toString;
      result = t1.$get$1(0, t1.$ti._eval$1("1*")._as(rhs));
      if (!H.boolConversionCheck(result.isSome$0())) {
        error = new S.PtlsError("Index Error", P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
        error.message = "Given key does not exist in dict";
        throw H.wrapException(error);
      }
      return type$.legacy_PtlsValue._as(type$.legacy_Some_dynamic._as(result)._a);
    },
    updateIndex$2: function(index, result) {
      return new O.PtlsDict(this.map.put$2(0, index, result));
    },
    delKey$1: function(key) {
      return new O.PtlsDict(this.map.remove$1(0, type$.legacy_PtlsValue._as(key)));
    },
    getField$2: function($name, loc) {
      var _this = this;
      switch ($name) {
  ...
  R.PtlsLabel.prototype = {
    ...
    getZeros$1: function(val) {
      var t1 = type$.legacy_PtlsValue,
        t2 = type$.legacy_PtlsNumber;
      return new T.PtlsArray(G.IVector_IVector$from(P.List_List$filled(H._asIntS(t2._as(t1._as(val).checkType$1(H.setRuntimeTypeInfo([C.Type_PtlsNumber_2Vr], type$.JSArray_legacy_Type))).value), new S.PtlsNumber(0), false, t2), t1));
    },
    getDebug$1: function(val) {
      type$.legacy_PtlsValue._as(val);
      $.$get$PtlsLabel_debugHandler().call$1(J.toString$0$(val));
      return val;
    },
    readFile$2: function(path, getLines) {
      var error, lines, t1, t2, _i,
        pathStr = type$.legacy_PtlsString._as(path.checkType$1(H.setRuntimeTypeInfo([C.Type_PtlsString_yq7], type$.JSArray_legacy_Type))).value,
    ...
    getLines$0: function() {
      P.stdin().readLineSync$0();
    },
    getWrap$1: function(value) {
      return B.PtlsTuple$(H.setRuntimeTypeInfo([type$.legacy_PtlsValue._as(value)], type$.JSArray_legacy_PtlsValue), this);
    },
    getWrapTuple$1: function(tuple) {
      type$.legacy_PtlsValue._as(tuple);
      tuple.checkType$1(H.setRuntimeTypeInfo([C.Type_PtlsTuple_ynv], type$.JSArray_legacy_Type));
      return B.PtlsTuple$(type$.legacy_PtlsTuple._as(tuple).members, this);
    },
    getWrapObject$1: function(object) {
      type$.legacy_PtlsValue._as(object);
      object.checkType$1(H.setRuntimeTypeInfo([C.Type_PtlsObject_YRK], type$.JSArray_legacy_Type));
      return F.PtlsObject$(type$.legacy_PtlsObject._as(object).env, this);
    },
    getField$2: function($name, loc) {
  ...
  R.PtlsLabel_closure.prototype = {
    call$1: function(str) {
      H.printString(J.toString$0$(str));
    },
    $signature: 13
  };
  R.PtlsLabel_getField_closure.prototype = {
    call$1: function(path) {
      return this.$this.readFile$2(type$.legacy_PtlsValue._as(path), false);
    },
    $signature: 7
  };
  R.PtlsLabel_getField_closure0.prototype = {
    call$1: function(path) {
      return this.$this.readFile$2(type$.legacy_PtlsValue._as(path), true);
    },
    $signature: 7
  };
  X.PtlsList.prototype = {
    ...
    toList$0: function(_) {
      var t1,
        ...
        result = H.setRuntimeTypeInfo([this.headThunk.getValue$0()], type$.JSArray_legacy_PtlsValue);
      for (t1 = type$.legacy_PtlsList; !tailIter.get$isEmpty(tailIter);) {
        t1._as(tailIter);
  ...
  X.PtlsList_concat_closure0.prototype = {
    call$0: function() {
      return type$.legacy_PtlsList._as(this.$this.tailThunk.getValue$0()).concat$2(this.env, this.rhsNode);
    },
    "call*": "call$0",
    $requiredArgCount: 0,
    $signature: 2
  ...
  D.PtlsSet.prototype = {
    ...
    addElem$1: function(elem) {
      return new D.PtlsSet(this.map.put$2(0, type$.legacy_PtlsValue._as(elem), null));
    },
    delElem$1: function(elem) {
      return new D.PtlsSet(this.map.remove$1(0, type$.legacy_PtlsValue._as(elem)));
    },
    getField$2: function($name, loc) {
      var _this = this;
      switch ($name) {
  ...
  X.PtlsString.prototype = {
    getField$2: function($name, loc) {
      ...
      switch ($name) {
        ...
        case "!getInt":
          return new S.PtlsNumber(P.int_parse(_this.value, null));
        case "!getFloat":
        ...
        case "!getList":
          ...
          t1.toString;
          t2 = type$.Runes;
          t2 = H.MappedIterable_MappedIterable(new P.Runes(t1), t2._eval$1("PtlsString*(Iterable.E)")._as(new X.PtlsString_getField_closure()), t2._eval$1("Iterable.E"), type$.legacy_PtlsString);
  ...
  X.PtlsString_getField_closure.prototype = {
    call$1: function(rune) {
      return new X.PtlsString(H.Primitives_stringFromCharCode(H._asIntS(rune)));
    },
    $signature: 35
  };
  ...
  L.PtlsValue.prototype = {
    contains$1: function(_, value) {
      this.checkType$1(H.setRuntimeTypeInfo([C.Type_PtlsDict_UYK, C.Type_PtlsSet_V0W], type$.JSArray_legacy_Type));
      throw H.wrapException(false);
    },
    getMember$1: function(index) {
      this.checkType$1(H.setRuntimeTypeInfo([C.Type_PtlsTuple_ynv], type$.JSArray_legacy_Type));
      throw H.wrapException(false);
    },
    getIndex$1: function(rhs) {
      this.checkType$1(H.setRuntimeTypeInfo([C.Type_PtlsDict_UYK, C.Type_PtlsArray_M0o], type$.JSArray_legacy_Type));
      throw H.wrapException(false);
    },
    updateIndex$2: function(index, result) {
      this.checkType$1(H.setRuntimeTypeInfo([C.Type_PtlsDict_UYK, C.Type_PtlsArray_M0o], type$.JSArray_legacy_Type));
    ...
    getField$2: function($name, loc) {
      ...
      this.checkType$1(H.setRuntimeTypeInfo([C.Type_PtlsObject_YRK], type$.JSArray_legacy_Type));
      throw H.wrapException(false);
    },
    updateField$2: function($name, result) {
      this.checkType$1(H.setRuntimeTypeInfo([C.Type_PtlsObject_YRK], type$.JSArray_legacy_Type));
    ...
    checkType$1: function(types) {
      var typesStr, error;
      type$.legacy_List_legacy_Type._as(types);
    ...
    checkIsList$0: function() {
      var error = new S.PtlsError("Type Error", P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
  ...
  Z.SourceFile.prototype = {
    getTokens$0: function() {
      ...
      if (_this.tokens == null) {
        t1 = _this.chars;
        tokenizer = new L.Tokenizer(_this.path, H.setRuntimeTypeInfo([], type$.JSArray_legacy_Location));
        t1.toString;
        tokenizer.chars = H.stringReplaceAllUnchecked(t1, "\r", "\n");
        tokenizer.getLocs$0();
        _this.set$tokens(P.List_List$from(tokenizer.getTokens$0(), true, type$.legacy_Token));
      }
      return _this.tokens;
    },
    getNode$0: function() {
    ...
    set$tokens: function(tokens) {
      this.tokens = type$.legacy_List_legacy_Token._as(tokens);
    }
  };
  Z.PreludeFile.prototype = {
    ...
    getEnv$0: function() {
      var t1 = this.env;
      return t1 == null ? this.env = type$.legacy_PtlsObject._as(A.$eval(Q.Env$(null), this.getNode$0())).env : t1;
    }
  };
  A.Thunk.prototype = {
    getValue$0: function() {
      var error, exception, _this = this;
      if (_this.value == null) {
        if (_this.lock) {
          error = new S.PtlsError("Name Error", P.LinkedHashSet_LinkedHashSet(type$.legacy_Location));
        ...
        _this.lock = true;
        try {
          _this.value = type$.legacy_PtlsValue._as(_this.func.call$0());
        } catch (exception) {
          H.unwrapException(exception);
          throw exception;
        } finally {
        ...
        return function $async$getTokens$0($async$errorCode, $async$result) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                t1 = H.setRuntimeTypeInfo([], type$.JSArray_legacy_Token);
                for (t2 = $async$self.getInitialTokens$0(), t2 = new P._SyncStarIterator(t2._outerHelper(), t2.$ti._eval$1("_SyncStarIterator<1>")); t2.moveNext$0();)
                  C.JSArray_methods.add$1(t1, t2.get$current(t2));
                t2 = type$.JSArray_legacy_Tok, isStartExpr = true, index = 0;
              case 3:
                // for condition
  ...
  G.WebPreludeFile.prototype = {
    getTokens$0: function() {
      ...
      if (_this.tokens == null) {
        _this.set$tokens(H.setRuntimeTypeInfo([], type$.JSArray_legacy_Token));
  ...
  G.WebPreludeFile_getTokens_closure.prototype = {
    call$1: function(tok) {
      return type$.legacy_Token._as(tok).tokType === C.Tok_18;
    },
    $signature: 36
  };
  G.main_closure.prototype = {
    call$1: function(chars) {
      var t1, t2, _i, token, error,
        source = new G.WebSourceFile("<web>", H._asStringS(chars));
  ...
  G.main_closure0.prototype = {
    call$0: function() {
      ...
      if (t1.commands.moveNext$0()) {
        t1 = t1.commands;
        t1 = type$.legacy_PtlsValue._as(t1.get$current(t1));
        t2 = type$.JSArray_legacy_Type;
        ...
        if (t1 instanceof B.PtlsTuple) {
          ...
          switch (label) {
            case "IOPrint":
              ...
              string = type$.legacy_PtlsString._as(args[0].checkType$1(H.setRuntimeTypeInfo([C.Type_PtlsString_yq7], t2)));
              $.$get$_context().$index(0, "printOut").apply$1(H.setRuntimeTypeInfo([string.value], type$.JSArray_legacy_String));
              break;
            default:
              D.invalidLabel(label);
          }
        } else {
          label = type$.legacy_PtlsLabel._as(t1).value;
          switch (label) {
            case "IOClearConsole":
  ...
  G.main_closure1.prototype = {
    call$1: function(str) {
      return $.$get$_context().$index(0, "debugHandler").apply$1(H.setRuntimeTypeInfo([str], type$.JSArray_legacy_String));
    },
    $signature: 37
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _instance_0_i(P._File.prototype, "get$length", "length$0", 20);
    _static_1(P, "js___convertToJS$closure", "_convertToJS", 39);
    _static_1(P, "js___convertToDart$closure", "_convertToDart", 40);
    _static(G, "dartz__none$closure", 0, null, ["call$1$0", "call$0"], ["none", function() {
      return G.none(type$.dynamic);
    }], 30, 1);
    _instance_0_u(G.StringMonoid.prototype, "get$zero", "zero$0", 8);
    var _;
    _instance_0_i(_ = G.IHashMap.prototype, "get$length", "length$0", 3);
    _instance_0_i(_, "get$iterator", "iterator$0", "Iterator<Tuple2<1*,2*>*>*()");
    _instance_0_i(_ = G.IList.prototype, "get$length", "length$0", 3);
    _instance_0_i(_, "get$iterator", "iterator$0", "Iterator<IList.A*>*()");
    _instance_0_i(_ = G.IMap.prototype, "get$values", "values$0", "IList<2*>*()");
    _instance_0_i(_, "get$length", "length$0", 3);
    _instance_0_i(_, "get$iterator", "iterator$0", "Iterator<Tuple2<1*,2*>*>*()");
    _instance_0_i(_ = G.IVector.prototype, "get$length", "length$0", 3);
    _instance_0_i(_, "get$iterator", "iterator$0", "Iterator<1*>*()");
    _instance_0_i(_ = G.Option.prototype, "get$length", "length$0", 3);
    _instance_0_i(_, "get$iterator", "iterator$0", "Iterator<Option.A*>*()");
    _instance_1_u(U.ASTNode.prototype, "get$showValue", "showValue$1", 34);
    _instance_0_u(_ = G.Parser.prototype, "get$getName", "getName$0", 4);
    _instance_0_u(_, "get$getTupleName", "getTupleName$0", 4);
    _instance_0_u(_, "get$getPair", "getPair$0", 4);
    _instance_0_u(_, "get$getOperation", "getOperation$0", 4);
    _instance_0_u(_, "get$getClause", "getClause$0", 4);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      $env_1_1_legacy_int: findType("@<int*>"),
      Blob: findType("Blob"),
      Cons_legacy_String: findType("Cons<String*>"),
      ...
      IListMonoid_legacy_String: findType("IListMonoid<String*>"),
      IVector_legacy_String: findType("IVector<String*>"),
      ImageData: findType("ImageData"),
      Invocation: findType("Invocation"),
      Iterable_dynamic: findType("Iterable<@>"),
      Iterable_int: findType("Iterable<int>"),
      Iterable_legacy_String: findType("Iterable<String*>"),
      JSArray_Map_dynamic_dynamic: findType("JSArray<Map<@,@>>"),
      JSArray_String: findType("JSArray<String>"),
      JSArray_dynamic: findType("JSArray<@>"),
      JSArray_int: findType("JSArray<int>"),
      JSArray_legacy_ASTNode: findType("JSArray<ASTNode*>"),
      JSArray_legacy_Location: findType("JSArray<Location*>"),
      JSArray_legacy_Object: findType("JSArray<Object*>"),
      JSArray_legacy_PtlsValue: findType("JSArray<PtlsValue*>"),
      JSArray_legacy_String: findType("JSArray<String*>"),
      JSArray_legacy_Tok: findType("JSArray<Tok*>"),
      ...
      ListQueue_legacy_Tok: findType("ListQueue<Tok*>"),
      ...
      Nil_legacy_String: findType("Nil<String*>"),
      Node: findType("Node"),
      Null: findType("Null"),
      ...
      ReversedListIterable_legacy_PtlsValue: findType("ReversedListIterable<PtlsValue*>"),
      ...
      legacy_IList_dynamic: findType("IList<@>*"),
      legacy_IList_legacy_String: findType("IList<String*>*"),
      ...
      legacy_List_legacy_ASTNode: findType("List<ASTNode*>*"),
      legacy_List_legacy_String: findType("List<String*>*"),
      legacy_List_legacy_Tok: findType("List<Tok*>*"),
      legacy_List_legacy_Token: findType("List<Token*>*"),
      legacy_List_legacy_Type: findType("List<Type*>*"),
      legacy_Location: findType("Location*"),
      legacy_Map_of_legacy_String_and_legacy_Thunk: findType("Map<String*,Thunk*>*"),
      legacy_Never: findType("0&*"),
      legacy_Object: findType("Object*"),
      legacy_PtlsBool: findType("PtlsBool*"),
      legacy_PtlsLabel: findType("PtlsLabel*"),
      legacy_PtlsList: findType("PtlsList*"),
      legacy_PtlsNumber: findType("PtlsNumber*"),
      legacy_PtlsObject: findType("PtlsObject*"),
      legacy_PtlsString: findType("PtlsString*"),
      legacy_PtlsTuple: findType("PtlsTuple*"),
      legacy_PtlsValue: findType("PtlsValue*"),
      legacy_Some_dynamic: findType("Some<@>*"),
      legacy_String: findType("String*"),
      legacy_Thunk: findType("Thunk*"),
      legacy_Tok: findType("Tok*"),
      legacy_Token: findType("Token*"),
      legacy__MapEntry: findType("_MapEntry*"),
      legacy_bool: findType("bool*"),
      legacy_int: findType("int*"),
      legacy_legacy_ASTNode_Function: findType("ASTNode*()*"),
      nullable_Future_Null: findType("Future<Null>?"),
      nullable_Gamepad: findType("Gamepad?"),
      nullable_List_String: findType("List<String>?"),
      nullable_Object: findType("Object?"),
      nullable_Tok: findType("Tok?"),
...
;
    ...
    C.List_oke = H.setRuntimeTypeInfo(makeConstList([C.Tok_41, C.Tok_63, C.Tok_11]), type$.JSArray_legacy_Tok);
  ...
  (function staticFields() {
    ...
    $.depth = 0;
    $.lastLoc = null;
    $.SourceFile_cache = P.LinkedHashMap_LinkedHashMap$_empty(type$.legacy_String, H.findType("SourceFile*"));
    $.keywords = P.LinkedHashMap_LinkedHashMap$_literal(["if", C.Tok_25, "then", C.Tok_57, "else", C.Tok_17, "where", C.Tok_62, "with", C.Tok_64, "cond", C.Tok_13, "case", C.Tok_7, "and", C.Tok_2, "or", C.Tok_45, "not", C.Tok_42, "in", C.Tok_27, "as", C.Tok_3, "true", C.Tok_6, "false", C.Tok_6, "for", C.Tok_22, "when", C.Tok_61, "yield", C.Tok_65, "import", C.Tok_26, "export", C.Tok_20, "requires", C.Tok_51, "throw", C.Tok_58, "try", C.Tok_59, "catch", C.Tok_8, "upval", C.Tok_60], type$.legacy_String, type$.legacy_Tok);
    $.opSyms = P.LinkedHashMap_LinkedHashMap$_literal(["+", C.Tok_0, "-", C.Tok_55, "*", C.Tok_37, "/", C.Tok_14, "**", C.Tok_47, "%", C.Tok_35, "+=", C.Tok_1, "-=", C.Tok_56, "*=", C.Tok_38, "/=", C.Tok_15, "**=", C.Tok_48, "%=", C.Tok_36, "|>", C.Tok_46, "=", C.Tok_4, "==", C.Tok_19, "!=", C.Tok_43, "<", C.Tok_33, ">", C.Tok_24, "<=", C.Tok_32, ">=", C.Tok_23, "=>", C.Tok_29, "$", C.Tok_16, "++", C.Tok_12], type$.legacy_String, type$.legacy_Tok);
    $.leftSyms = P.LinkedHashMap_LinkedHashMap$_literal(["(", C.Tok_34, "{", C.Tok_31, "[", C.Tok_30], type$.legacy_String, type$.legacy_Tok);
    $.rightSyms = P.LinkedHashMap_LinkedHashMap$_literal([")", C.Tok_52, "}", C.Tok_50, "]", C.Tok_49], type$.legacy_String, type$.legacy_Tok);
    $.separators = P.LinkedHashMap_LinkedHashMap$_literal([";", C.Tok_53, ":", C.Tok_9, ",", C.Tok_10], type$.legacy_String, type$.legacy_Tok);
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "opSymChars", "$get$opSymChars", function() {
      var t2, t3,
        t1 = P.LinkedHashSet_LinkedHashSet(type$.legacy_String);
    ...
    _lazy($, "Tokenizer_digits", "$get$Tokenizer_digits", function() {
      return P.LinkedHashSet_LinkedHashSet$of(H.setRuntimeTypeInfo("0123456789".split(""), type$.JSArray_String), type$.legacy_String);
    });
    _lazy($, "Tokenizer_lowers", "$get$Tokenizer_lowers", function() {
      return P.LinkedHashSet_LinkedHashSet$of(H.setRuntimeTypeInfo("abcdefghijklmnopqrstuvwxyz".split(""), type$.JSArray_String), type$.legacy_String);
    });
    ...
    _lazy($, "Tokenizer_alnums", "$get$Tokenizer_alnums", function() {
      ...
      for (t2 = $.$get$Tokenizer_lowers(), t2 = t2.get$iterator(t2); t2.moveNext$0();)
        t1.add$1(0, H._asStringS(t2.get$current(t2)));
    ...
    _lazy($, "Tokenizer_startToks", "$get$Tokenizer_startToks", function() {
      ...
      for (t3 = $.opSyms, t3 = t3.get$values(t3), t3 = t3.get$iterator(t3); t3.moveNext$0();)
        t2.add$1(0, t1._as(t3.get$current(t3)));
    ...
    _lazy($, "Tokenizer_endSyms", "$get$Tokenizer_endSyms", function() {
      var t2,
        t1 = P.LinkedHashSet_LinkedHashSet(type$.legacy_Tok);
