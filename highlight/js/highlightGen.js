...
(function dartProgram() {
  ...
  L = {Token: function Token(t0, t1, t2) {
      ...
      this.value = t1;
      this.loc = t2;
    }, Tokenizer: function Tokenizer(t0, t1, t2) {
      var _ = this;
  ...
  B = {
    highlight: function(chars) {
      ...
      H._asStringNullable(chars);
      source = new Z.SourceFile("<web>", chars);
      annotations = [];
      tokenizer = new L.Tokenizer(chars, "<web>", H.setRuntimeTypeInfo([], type$.JSArray_Location));
      tokenizer.getLocs$0();
      source.set$tokens(P.List_List$from(tokenizer.getTokens$0(), true, type$.Token));
      t1 = source.tokens;
      t2 = t1.length;
      _i = 0;
  ...
  L.Tokenizer.prototype = {
    ...
    getLocs$0: function() {
      var t2, t3, t4, t5, lineNum, colNum, _i, c, t6,
        t1 = this.chars,
        lines = t1.split("\n");
      for (t2 = t1.split(""), t3 = t2.length, t4 = this.locs, t5 = this.path, lineNum = 1, colNum = 1, _i = 0; _i < t3; ++_i) {
        c = t2[_i];
        t6 = lineNum - 1;
        if (t6 >= lines.length)
          return H.ioore(lines, t6);
        C.JSArray_methods.add$1(t4, new V.Location(lineNum, colNum, t5, lines[t6]));
        if (J.$eq$(c, "\n")) {
          ++lineNum;
          colNum = 1;
        } else
      ...
      C.JSArray_methods.add$1(t4, new V.Location(lineNum, colNum, t5, t1));
    },
    makeToken$1: function(tokType) {
      var _this = this,
        t1 = _this.tokIndex,
        t2 = _this.index,
        value = J.substring$2$s(_this.chars, t1, t2),
        t3 = _this.locs;
      if (t1 >= t3.length)
        return H.ioore(t3, t1);
      t1 = t3[t1];
      _this.tokIndex = t2;
      return new L.Token(tokType, value, t1);
    },
    ...
    handleName$0: function() {
      var t2, t3, t4, value, _this = this,
        t1 = _this.chars;
      while (true) {
        t2 = $.$get$Tokenizer_alnums();
        t3 = _this.index;
        t4 = t1.length;
        if (!t2.contains$1(0, t3 < t4 ? t1[t3] : null))
          break;
        t2 = _this.index++;
        if (t2 >= t4)
          return H.ioore(t1, t2);
      ...
      value = J.substring$2$s(t1, _this.tokIndex, _this.index);
    ...
    handleOpSym$0: function() {
      var t2, t3, t4, value, error, _this = this,
        t1 = _this.chars;
      while (true) {
        t2 = $.$get$opSymChars();
        t3 = _this.index;
        ...
        return function $async$getInitialTokens$0($async$errorCode, $async$result) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                t1 = $async$self.chars.length;
              case 2:
                // for condition
                if (!($async$self.index < t1)) {
                  // goto after for
                  $async$goto = 3;
                  break;
                }
  ...
  var init = {
    ...
    metadata: [],
    types: ["@(@)", "Null(String,@)", "@(@,String)", "@(String)", "Null(@,@)", "Null(Symbol0,@)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "Object(@)", "String(String)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: typeof Symbol == "function" && typeof Symbol() == "symbol" ? Symbol("$ti") : "$ti"
  };
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"JavaScriptFunction":"JavaScriptObject","PlainJavaScriptObject":"JavaScriptObject","UnknownJavaScriptObject":"JavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"Element","GraphicsElement":"Element","SvgElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","DedicatedWorkerGlobalScope":"WorkerGlobalScope","CDataSection":"CharacterData","Text":"CharacterData","File":"Blob","NativeFloat32List":"NativeTypedArrayOfDouble","NativeByteData":"NativeTypedData","JSBool":{"bool":[]},"JavaScriptObject":{"Function":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"double":[],"num":[]},"JSInt":{"int":[],"double":[],"num":[]},"JSDouble":{"double":[],"num":[]},"JSString":{"String":[],"Pattern":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"ListIterator":{"Iterator":["1"]},"MappedIterable":{"Iterable":["2"]},"EfficientLengthMappedIterable":{"MappedIterable":["1","2"],"Iterable":["2"]},"MappedIterator":{"Iterator":["2"]},"MappedListIterable":{"ListIterable":["2"],"Iterable":["2"],"ListIterable.E":"2"},"Symbol":{"Symbol0":[]},"ConstantMapView":{"UnmodifiableMapView":["1","2"],"_UnmodifiableMapView_MapView__UnmodifiableMapMixin":["1","2"],"MapView":["1","2"],"_UnmodifiableMapMixin":["1","2"],"Map":["1","2"]},"ConstantMap":{"Map":["1","2"]},"ConstantStringMap":{"ConstantMap":["1","2"],"Map":["1","2"]},"JSInvocationMirror":{"Invocation":[]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"Closure":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"LinkedHashMap":["1","2"],"MapMixin":["1","2"],"Map":["1","2"]},"LinkedHashMapKeyIterable":{"Iterable":["1"]},"LinkedHashMapKeyIterator":{"Iterator":["1"]},"JSSyntaxRegExp":{"Pattern":[]},"NativeTypedData":{"TypedData":[]},"NativeTypedArray":{"JavaScriptIndexingBehavior":["@"],"TypedData":[]},"NativeTypedArrayOfDouble":{"ListMixin":["double"],"JavaScriptIndexingBehavior":["@"],"List":["double"],"FixedLengthListMixin":["double"],"TypedData":[],"Iterable":["double"],"ListMixin.E":"double"},"NativeTypedArrayOfInt":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"]},"NativeInt16List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"],"ListMixin.E":"int"},"NativeInt32List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"],"ListMixin.E":"int"},"NativeInt8List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"],"ListMixin.E":"int"},"NativeUint16List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"],"ListMixin.E":"int"},"NativeUint32List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"],"ListMixin.E":"int"},"NativeUint8ClampedList":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"],"ListMixin.E":"int"},"NativeUint8List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"],"ListMixin.E":"int"},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"_SyncStarIterator":{"Iterator":["1"]},"_SyncStarIterable":{"Iterable":["1"]},"_LinkedHashSet":{"_SetBase":["1"],"LinkedHashSet":["1"],"Iterable":["1"]},"_LinkedHashSetIterator":{"Iterator":["1"]},"IterableBase":{"Iterable":["1"]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"MapView":{"Map":["1","2"]},"UnmodifiableMapView":{"_UnmodifiableMapView_MapView__UnmodifiableMapMixin":["1","2"],"MapView":["1","2"],"_UnmodifiableMapMixin":["1","2"],"Map":["1","2"]},"_SetBase":{"Iterable":["1"]},"double":{"num":[]},"AssertionError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"NoSuchMethodError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"int":{"num":[]},"List":{"Iterable":["1"]},"String":{"Pattern":[]},"HtmlElement":{"Node":[]},"AnchorElement":{"Node":[]},"AreaElement":{"Node":[]},"CharacterData":{"Node":[]},"Element":{"Node":[]},"FormElement":{"Node":[]},"SelectElement":{"Node":[]},"JsFunction":{"JsObject":[]},"JsArray":{"ListMixin":["1"],"List":["1"],"JsObject":[],"Iterable":["1"],"ListMixin.E":"1"}}'));
  H._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"EfficientLengthIterable":1,"IterableBase":1,"MapBase":2,"_JsArray_JsObject_ListMixin":1}'));
