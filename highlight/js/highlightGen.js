...
(function dartProgram() {
  ...
  P = {
    ...
    RegExp_RegExp: function(source, multiLine) {
      return new H.JSSyntaxRegExp(source, H.JSSyntaxRegExp_makeNative(source, true, true, false, false, false));
    },
  ...
  Z = {SourceFile: function SourceFile(t0, t1) {
      this.path = t0;
      this.chars = t1;
      this.tokens = null;
    }},
  L = {Token: function Token(t0, t1, t2) {
      this.tokType = t0;
      this.value = t1;
      this.loc = t2;
  ...
  U = {Tok: function Tok(t0) {
      this._tokenTypes$_name = t0;
    }},
  B = {
    highlight: function(chars) {
      var source, annotations, tokenizer, t1, t2, _i, token, t3, t4, color, escaped;
      H._asStringS(chars);
      source = new Z.SourceFile("<web>", chars);
      annotations = [];
      tokenizer = new L.Tokenizer("<web>", H.setRuntimeTypeInfo([], type$.JSArray_legacy_Location));
      chars.toString;
      tokenizer.chars = H.stringReplaceAllUnchecked(chars, "\r", "\n");
      tokenizer.getLocs$0();
      source.set$tokens(P.List_List$from(tokenizer.getTokens$0(), true, type$.legacy_Token));
      t1 = source.tokens;
      t2 = t1.length;
      _i = 0;
      for (; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
        ...
        if (t3.containsKey$1(t4))
          color = "#c594c5";
        else if ($.opSyms.containsKey$1(t4))
          color = "#F97B58";
        else if ($.$get$preludeNames().contains$1(0, t4))
          color = "#6699cc";
        else {
          t3 = token.tokType;
          if (t3 === C.Tok_28)
            ...
            color = t3 === C.Tok_11 ? "#A6ACB9" : "#D8DEE9";
        }
        t3 = H.stringReplaceAllUnchecked(t4, "&", "&amp;");
        t3 = H.stringReplaceAllUnchecked(t3, "<", "&lt;");
        t3 = H.stringReplaceAllUnchecked(t3, ">", "&gt;");
        t3 = H.stringReplaceAllUnchecked(t3, '"', "&quot;");
        escaped = H.stringReplaceAllUnchecked(t3, "'", "&#039;");
        annotations.push("<span style='color: " + color + ";'>" + escaped + "</span>");
      }
      return C.JSArray_methods.join$1(annotations, "");
    },
    main: function() {
      $.$get$_context().$indexSet(0, "highlight", B.highlightGen__highlight$closure());
    }
  },
  Y = {
    getExports: function(exportsText) {
      var nameStr, t2, t3, _i, $name, t4,
        t1 = P.RegExp_RegExp("^\\s*export\\s*{([a-zA-Z0-9,\\s]*)}", true).firstMatch$1(exportsText);
      if (t1 == null)
        nameStr = null;
      else {
        t1 = t1._match;
      ...
      for (t2 = nameStr.split(","), t3 = t2.length, _i = 0; _i < t3; ++_i) {
        $name = t2[_i];
        t4 = J.getInterceptor$s($name);
        if (t4.trim$0($name).length !== 0)
          t1.add$1(0, t4.trim$0($name));
      }
      return t1;
    }
  };
  var holders = [C, H, J, P, W, V, S, Z, L, U, B, Y];
  ...
  P._SetBase.prototype = {
    ...
    join$1: function(_, separator) {
      var t1,
        iterator = P._LinkedHashSetIterator$(this, this._modifications, H._instanceType(this)._precomputed1);
      if (!iterator.moveNext$0())
        return "";
      if (separator === "") {
        t1 = "";
  ...
  V.Location.prototype = {
    ...
    toString$0: function(_) {
      var _this = this,
        t1 = _this.colNum;
      return "\nAt " + ("(line " + _this.lineNum + " column " + t1 + ")") + " in '" + _this.path + "'\n" + (H.S(_this.line) + "\n" + C.JSString_methods.$mul(" ", t1 - 1) + "^");
    }
  };
  ...
  L.Tokenizer.prototype = {
    ...
    handleName$0: function() {
      ...
      if ($.keywords.containsKey$1(value))
    ...
    getToken$0: function() {
      ...
      if ($.separators.containsKey$1(_this.getChar$1(0))) {
        sym = _this.advance$0();
      ...
      if ($.leftSyms.containsKey$1(_this.getChar$1(0))) {
        value = _this.advance$0();
        return _this.makeToken$1($.leftSyms.$index(0, value));
      }
      if ($.rightSyms.containsKey$1(_this.getChar$1(0))) {
        value = _this.advance$0();
            ...
            switch ($async$goto) {
              case 0:
                ...
                for (t2 = $async$self.getInitialTokens$0(), t2 = new P._SyncStarIterator(t2._outerHelper(), t2.$ti._eval$1("_SyncStarIterator<1>")); t2.moveNext$0();)
                  C.JSArray_methods.add$1(t1, t2.get$current());
  ...
  (function installTearOffs() {
    ...
    _static_1(B, "highlightGen__highlight$closure", "highlight", 10);
  })();
  (function inheritance() {
    ...
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, P.Iterable, H.ListIterator, P.Iterator, H.FixedLengthListMixin, H.Symbol, P.MapView, H.ConstantMap, H.JSInvocationMirror, H.Closure, H.TypeErrorDecoder, P.Error, H.NullThrownFromJavaScriptException, H._Required, P.MapMixin, H.LinkedHashMapCell, H.LinkedHashMapKeyIterator, H.JSSyntaxRegExp, H._MatchImplementation, H.Rti, H._FunctionParameters, P._IterationMarker, P._SyncStarIterator, P._SetBase, P._LinkedHashSetCell, P._LinkedHashSetIterator, P.ListMixin, P._UnmodifiableMapMixin, P.bool, P.DateTime, P.num, P.OutOfMemoryError, P.StackOverflowError, P.FormatException, P.List, P.Null, P.String, P.StringBuffer, P.Symbol0, P.JsObject, V.Location, S.PtlsError, Z.SourceFile, L.Token, U.Tok, L.Tokenizer]);
    ...
    _inheritMany(P.Iterable, [H.EfficientLengthIterable, H.MappedIterable, P.IterableBase]);
    ...
    _inheritMany(H.Closure, [H.Primitives_functionNoSuchMethod_closure, H.TearOffClosure, H.JsLinkedHashMap_values_closure, H.initHooks_closure, H.initHooks_closure0, H.initHooks_closure1, P.MapBase_mapToString_closure, P.NoSuchMethodError_toString_closure, P._convertToJS_closure, P._convertToJS_closure0, P._wrapToDart_closure, P._wrapToDart_closure0, P._wrapToDart_closure1]);
  ...
  var init = {
    ...
    metadata: [],
    types: ["@(@)", "Null(String,@)", "@(@,String)", "@(String)", "Null(Object?,Object?)", "Null(Symbol0,@)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "Object?(@)", "String*(String*)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: typeof Symbol == "function" && typeof Symbol() == "symbol" ? Symbol("$ti") : "$ti"
  };
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"JavaScriptFunction":"JavaScriptObject","PlainJavaScriptObject":"JavaScriptObject","UnknownJavaScriptObject":"JavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"Element","GraphicsElement":"Element","SvgElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","DedicatedWorkerGlobalScope":"WorkerGlobalScope","CDataSection":"CharacterData","Text":"CharacterData","File":"Blob","NativeFloat32List":"NativeTypedArrayOfDouble","NativeByteData":"NativeTypedData","JSBool":{"bool":[]},"JavaScriptObject":{"Function":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"double":[],"num":[]},"JSInt":{"double":[],"int":[],"num":[]},"JSDouble":{"double":[],"num":[]},"JSString":{"String":[],"Pattern":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"ListIterator":{"Iterator":["1"]},"MappedIterable":{"Iterable":["2"]},"EfficientLengthMappedIterable":{"MappedIterable":["1","2"],"Iterable":["2"]},"MappedIterator":{"Iterator":["2"]},"MappedListIterable":{"ListIterable":["2"],"Iterable":["2"],"ListIterable.E":"2"},"Symbol":{"Symbol0":[]},"ConstantMapView":{"UnmodifiableMapView":["1","2"],"_UnmodifiableMapView_MapView__UnmodifiableMapMixin":["1","2"],"MapView":["1","2"],"_UnmodifiableMapMixin":["1","2"],"Map":["1","2"]},"ConstantMap":{"Map":["1","2"]},"ConstantStringMap":{"ConstantMap":["1","2"],"Map":["1","2"]},"JSInvocationMirror":{"Invocation":[]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"Closure":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapMixin":["1","2"],"LinkedHashMap":["1","2"],"Map":["1","2"]},"LinkedHashMapKeyIterable":{"Iterable":["1"]},"LinkedHashMapKeyIterator":{"Iterator":["1"]},"JSSyntaxRegExp":{"Pattern":[]},"NativeTypedData":{"TypedData":[]},"NativeTypedArray":{"JavaScriptIndexingBehavior":["1"],"TypedData":[]},"NativeTypedArrayOfDouble":{"ListMixin":["double"],"JavaScriptIndexingBehavior":["double"],"List":["double"],"TypedData":[],"Iterable":["double"],"FixedLengthListMixin":["double"],"ListMixin.E":"double"},"NativeTypedArrayOfInt":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"]},"NativeInt16List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeInt32List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeInt8List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeUint16List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeUint32List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeUint8ClampedList":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeUint8List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"_SyncStarIterator":{"Iterator":["1"]},"_SyncStarIterable":{"Iterable":["1"]},"_LinkedHashSet":{"_SetBase":["1"],"LinkedHashSet":["1"],"Iterable":["1"]},"_LinkedHashSetIterator":{"Iterator":["1"]},"IterableBase":{"Iterable":["1"]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"MapView":{"Map":["1","2"]},"UnmodifiableMapView":{"_UnmodifiableMapView_MapView__UnmodifiableMapMixin":["1","2"],"MapView":["1","2"],"_UnmodifiableMapMixin":["1","2"],"Map":["1","2"]},"_SetBase":{"Iterable":["1"]},"double":{"num":[]},"AssertionError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"NoSuchMethodError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"int":{"num":[]},"List":{"Iterable":["1"]},"String":{"Pattern":[]},"HtmlElement":{"Node":[]},"AnchorElement":{"Node":[]},"AreaElement":{"Node":[]},"CharacterData":{"Node":[]},"Element":{"Node":[]},"FormElement":{"Node":[]},"SelectElement":{"Node":[]},"JsArray":{"ListMixin":["1"],"List":["1"],"Iterable":["1"],"ListMixin.E":"1"}}'));
  H._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"EfficientLengthIterable":1,"NativeTypedArray":1,"IterableBase":1,"MapBase":2,"_JsArray_JsObject_ListMixin":1}'));
  0;
...
;
  ...
  (function staticFields() {
    ...
    $.preludeList = function() {
      var t1 = H.findType("JSArray<String*>");
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "opSymChars", "$get$opSymChars", function() {
      var t2, t3,
        t1 = P.LinkedHashSet_LinkedHashSet(type$.legacy_String);
      for (t2 = $.opSyms.get$keys(), t2 = t2.get$iterator(t2); t2.moveNext$0();) {
        t3 = t2.get$current();
        if (0 >= t3.length)
          return H.ioore(t3, 0);
        t1.add$1(0, t3[0]);
    ...
    _lazy($, "Tokenizer_alnums", "$get$Tokenizer_alnums", function() {
      ...
      for (t2 = $.$get$Tokenizer_lowers(), t2 = t2.get$iterator(t2); t2.moveNext$0();)
        t1.add$1(0, H._asStringS(t2.get$current()));
    ...
    _lazy($, "Tokenizer_startToks", "$get$Tokenizer_startToks", function() {
      ...
      for (t3 = $.opSyms, t3 = t3.get$values(t3), t3 = t3.get$iterator(t3); t3.moveNext$0();)
        t2.add$1(0, t1._as(t3.get$current()));
    ...
    _lazy($, "exportsText", "$get$exportsText", function() {
      return $.preludeList[0][1];
    });
    _lazy($, "preludeNames", "$get$preludeNames", function() {
      return Y.getExports($.$get$exportsText());
    });
  })();
...
//# sourceMappingURL=highlightGen.js.map
